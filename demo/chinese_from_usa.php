...
<title>E-TraveltoChina.com - 搜索</title>
...
<center>
  <div id="WDSWaitingImageDivID" style="display: none; align: center;">
    <div id="divWait">
      ...
      <p id="title"> 我们正在处理您的申请，请稍候...</p>
      <p id="indicator"> <img id="WDSProgressImageImgID" alt='我们正在处理您的申请，请稍候...' /></p>
      <p id="info"> </p>
    </div>
  </div>
</center>
...
<input type="hidden" name="LANGUAGE" value='CN' /> -->
    ...
    <table width="100%" cellspacing="0" cellpadding="0" class="tableSearchDiv">
      <tr>
        <td><div id="rt">
            <ul id="tabnav">
              <li id="roundTripTab" class="t2_selected"><a id="roundTripTabLink" href="javascript:selectRTab();"> 往返旅行</a> </li>
              <li id="oneWayTab" class="t2_unselected"><a id="oneWayTabLink" href="javascript:selectOTab();"> 单程</a> </li>
        ...
        <td colspan="3"><div id="complexDataId" style="visibility: hidden; display: none; height: 1px;">
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
              <tr style="display:none;">
                <td><span class="textSmaller">* 如果不确定某个城市或机场的英文拼写，请输入前 3 个或更多字母并加上一个星号 (*)。&nbsp;</span></td>
              </tr>
              <tr>
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                      <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRB_LOCATION_1_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">始发</span>城市或机场* </td>
                                    </tr>
                                    <tr id="Table_B_LOCATION_1_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="B_LOCATION_1_Cpx" id="B_LOCATION_1_Cpx" value="Los Angeles" type="text"
                                                                                                                size="30" />
                                        <span class="ImgLookUp" title="单击此处可启动首选航空公司弹出窗口" onclick="javascript:etravel.openLocation('B_LOCATION_1_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
	    		...
	    		<option value="New York" >纽&nbsp;&nbsp;&nbsp;约(NYC)</option>	    		
	    		<option value="San Francisco" class="br">旧金山(SFO)</option>	
	    		<option value="Boston" >波士顿(BOS)</option>
	    		<option value="Chicago">芝加哥(CHI)</option>
	    		<option value="Houston"  class="br">休斯敦(HOU)</option>
	    		<option value="Washington">华盛顿(WAS)</option>
	    		<option value="Seattle"  class="br">西雅图(SEA)</option>
	    		<option value="Others">其它城市(英文填写)</option>
	    	</select>
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                      <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRE_LOCATION_1_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">目的</span>城市或机场* </td>
                                    </tr>
                                    <tr id="Table_E_LOCATION_1_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="E_LOCATION_1_Cpx" id="E_LOCATION_1_Cpx" value="Beijing" type="text"
                                                                                                                size="30" />
                                        </span><span class="ImgLookUp" title="单击此处可启动城市弹出窗口" onclick="javascript:etravel.openLocation('E_LOCATION_1_Cpx');"> &nbsp;</span></td>
                                    </tr>
  ...
  <option value="CAN" class="br">广州(CAN)</option>
  <option value="FOC">福州(FOC)</option>
  <option value="CTU">成都(CTU)</option>
  <option value="SZX" class="br">深圳(SZX)</option>
  <option value="WNZ">温州(WNZ)</option>
  <option value="CKG">重庆(CKG)</option>
  <option value="XIY" class="br">西安(XIY)</option>
  <option value="HGH">杭州(HGH)</option>
  <option value="NKG">南京(NKG)</option>
  <option value="WUH" class="br">武汉(WUH)</option>
  <option value="SHE">沈阳(SHE)</option>
  <option value="KMG">昆明(KMG)</option>
  <option value="XMN" class="br">厦门(XMN)</option>
  <option value="TNA" >济南(TNA)</option>
  <option value="DLC">大连(DLC)</option>
  <option value="TAO"class="br">青岛(TAO)</option>
  <option value="CSX">长沙(CSX)</option>
  <option value="CGO">郑州(CGO)</option>
  <option value="CGQ" class="br">长春(CGQ)</option>
  <option value="HKG">香港(HKG)</option>
  <option value="TPE">台北(TPE)</option>
   <option value="HRB" class="br">哈尔滨(HRB)</option>
  <option value="Others">其它城市(英文或汉语拼音填写)</option>
</select>
                            ...
                            <div class="searchDateSelectionPanel" id="divB_DATE1Cpx">
                              <ul class="selector date">
                                ...
                                <li class="value" id="DateCmp1Cpx">
                                  <label for="Month1Cpx"> <span class="ImgError" id="WDSErrorImgB_DATE1Cpx" style="display: none">&nbsp;</span>启程日期</label>
                                  ...
                                  <span id="linkCalendar1Cpx" title="单击此处可搜索日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell1Cpx" name="originDateDayOfWeekCell1Cpx"> </span>
                              ...
                              <ul class="selector time" id="timeSelector1Cpx">
                                ...
                                <li class="value" id="timeCell1Cpx">
                                  <label for="Hours1Cpx"> 启程时间 </label>
                                  <span id="timeCellDropDown1Cpx">
                                  <select id="Hours1Cpx" name="Hours1Cpx" class="simpleBox BeginTime" >
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table_B_LOCATION_2_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        ...
                                        <span class="ImgLookUp" title="单击此处可启动城市弹出窗口" onclick="javascript:etravel.openLocation('B_LOCATION_2_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
	    		...
	    		<option value="Houston"  class="br">休斯敦(HOU)</option>
	    		<option value="Washington">华盛顿(WAS)</option>
	    		<option value="Seattle">西雅图(SEA)</option>
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table_E_LOCATION_2_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        ...
                                        <span class="ImgLookUp" title="单击此处可启动城市弹出窗口" onclick="javascript:etravel.openLocation('E_LOCATION_2_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                            ...
                            <div class="searchDateSelectionPanel" id="divB_DATE2Cpx">
                              <ul class="selector date">
                                ...
                                <li class="value" id="DateCmp2Cpx">
                                  <label for="Month2Cpx"> <span class="ImgError" id="WDSErrorImgB_DATE2Cpx" style="display: none">&nbsp;</span>启程日期</label>
                                  ...
                                  <span id="linkCalendar2Cpx" title="单击此处可搜索日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell2Cpx" name="originDateDayOfWeekCell2Cpx"> </span>
                              ...
                              <ul class="selector time" id="timeSelector2Cpx">
                                ...
                                <li class="value" id="timeCell2Cpx">
                                  <label for="Hours2Cpx"> 启程时间 </label>
                                  <span id="timeCellDropDown2Cpx">
                                  <select id="Hours2Cpx" name="Hours2Cpx" class="simpleBox BeginTime" >
                                    <option value="ANY" selected="selected">任意时间 </option>
                                    <option value="0000">00:00 </option>
                                    <option value="0100">1:00 </option>
                                    <option value="0200">2:00 </option>
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table_B_LOCATION_3_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        ...
                                        <span class="ImgLookUp" title="单击此处可启动城市弹出窗口" onclick="javascript:etravel.openLocation('B_LOCATION_3_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                                    <tr id="Table2_B_LOCATION_3_Cpx">
                                      <td nowrap="nowrap">
                                        <select tyle="width: 160px;" name="From_B_LOCATION_3_Cpx" id="From_B_LOCATION_3_Cpx" onchange="selectChange('From_B_LOCATION_3_Cpx','B_LOCATION_3_Cpx')" class="selectable flight">
                <option value="Los Angeles">洛杉矶(LAX)</option>
	    		<option value="New York" >纽&nbsp;&nbsp;&nbsp;约(NYC)</option>	    		
	    		<option value="San Francisco" class="br">旧金山(SFO)</option>	
	    		<option value="Boston" >波士顿(BOS)</option>
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table_E_LOCATION_3_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        ...
                                        <span class="ImgLookUp" title="单击此处可启动城市弹出窗口" onclick="javascript:etravel.openLocation('E_LOCATION_3_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
...
<select style="width: 160px;" name="From_E_LOCATION_3_Cpx" id="From_E_LOCATION_3_Cpx" onchange="selectChange('From_E_LOCATION_3_Cpx','E_LOCATION_3_Cpx')" class="selectable flight">
                            ...
                            <div class="searchDateSelectionPanel" id="divB_DATE3Cpx">
                              <ul class="selector date">
                                ...
                                <li class="value" id="DateCmp3Cpx">
                                  <label for="Month3Cpx"> <span class="ImgError" id="WDSErrorImgB_DATE3Cpx" style="display: none">&nbsp;</span>启程日期</label>
                                  ...
                                  <span id="linkCalendar3Cpx" title="单击此处可搜索日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell3Cpx" name="originDateDayOfWeekCell3Cpx"> </span>
                              ...
                              <ul class="selector time" id="timeSelector3Cpx">
                                ...
                                <li class="value" id="timeCell3Cpx">
                                  <label for="Hours3Cpx"> 启程时间 </label>
                                  <span id="timeCellDropDown3Cpx">
                                  <select id="Hours3Cpx" name="Hours3Cpx" class="simpleBox BeginTime" >
                                    <option value="ANY" selected="selected">任意时间 </option>
                                    <option value="0000">00:00 </option>
                                    <option value="0100">1:00 </option>
                                    <option value="0200">2:00 </option>
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table_B_LOCATION_4_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        ...
                                        <span class="ImgLookUp" title="单击此处可启动城市弹出窗口" onclick="javascript:etravel.openLocation('B_LOCATION_4_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                                    <tr id="Table2_B_LOCATION_4_Cpx">
                                      <td nowrap="nowrap"><select style="width: 160px;" name="From_B_LOCATION_4_Cpx" id="From_B_LOCATION_4_Cpx"
										  ...
										  <option value="Boston">波士顿</option>
										  <option value="Chicago">芝加哥</option>
										  <option value="Houston">休斯敦</option>
										  <option value="Washington">华盛顿</option>
										  <option value="Seattle">西雅图</option>
                                          <option style="font-weight: bold" value="Others">其它城市（英文填写）</option>
                                        </select></td>
                                    </tr>
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table_E_LOCATION_4_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        ...
                                        <span class="ImgLookUp" title="单击此处可启动城市弹出窗口" onclick="javascript:etravel.openLocation('E_LOCATION_4_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                            ...
                            <div class="searchDateSelectionPanel" id="divB_DATE4Cpx">
                              <ul class="selector date">
                                ...
                                <li class="value" id="DateCmp4Cpx">
                                  <label for="Month4Cpx"> <span class="ImgError" id="WDSErrorImgB_DATE4Cpx" style="display: none">&nbsp;</span>启程日期</label>
                                  ...
                                  <span id="linkCalendar4Cpx" title="单击此处可搜索日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell4Cpx" name="originDateDayOfWeekCell4Cpx"> </span>
                              ...
                              <ul class="selector time" id="timeSelector4Cpx">
                                ...
                                <li class="value" id="timeCell4Cpx">
                                  <label for="Hours4Cpx"> 启程时间 </label>
                                  <span id="timeCellDropDown4Cpx">
                                  <select id="Hours4Cpx" name="Hours4Cpx" class="simpleBox BeginTime" >
                                    <option value="ANY" selected="selected">任意时间 </option>
                                    <option value="0000">00:00 </option>
                                    <option value="0100">1:00 </option>
                                    <option value="0200">2:00 </option>
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table_B_LOCATION_5_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        ...
                                        <span class="ImgLookUp" title="单击此处可启动城市弹出窗口" onclick="javascript:etravel.openLocation('B_LOCATION_5_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table_E_LOCATION_5_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        ...
                                        <span class="ImgLookUp" title="单击此处可启动城市弹出窗口" onclick="javascript:etravel.openLocation('E_LOCATION_5_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                            ...
                            <div class="searchDateSelectionPanel" id="divB_DATE5Cpx">
                              <ul class="selector date">
                                ...
                                <li class="value" id="DateCmp5Cpx">
                                  <label for="Month5Cpx"> <span class="ImgError" id="WDSErrorImgB_DATE5Cpx" style="display: none">&nbsp;</span>启程日期</label>
                                  ...
                                  <span id="linkCalendar5Cpx" title="单击此处可搜索日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell5Cpx" name="originDateDayOfWeekCell5Cpx"> </span>
                              ...
                              <ul class="selector time" id="timeSelector5Cpx">
                                ...
                                <li class="value" id="timeCell5Cpx">
                                  <label for="Hours5Cpx"> 启程时间 </label>
                                  <span id="timeCellDropDown5Cpx">
                                  <select id="Hours5Cpx" name="Hours5Cpx" class="simpleBox BeginTime" >
                                    <option value="ANY" selected="selected">任意时间 </option>
                                    <option value="0000">00:00 </option>
                                    <option value="0100">1:00 </option>
                                    <option value="0200">2:00 </option>
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table_B_LOCATION_6_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        ...
                                        <span class="ImgLookUp" title="单击此处可启动城市弹出窗口" onclick="javascript:etravel.openLocation('B_LOCATION_6_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table_E_LOCATION_6_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        ...
                                        <span class="ImgLookUp" title="单击此处可启动城市弹出窗口" onclick="javascript:etravel.openLocation('E_LOCATION_6_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                            ...
                            <div class="searchDateSelectionPanel" id="divB_DATE6Cpx">
                              <ul class="selector date">
                                ...
                                <li class="value" id="DateCmp6Cpx">
                                  <label for="Month6Cpx"> <span class="ImgError" id="WDSErrorImgB_DATE6Cpx" style="display: none">&nbsp;</span>启程日期</label>
                                  ...
                                  <span id="linkCalendar6Cpx" title="单击此处可搜索日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell6Cpx" name="originDateDayOfWeekCell6Cpx"> </span>
                              ...
                              <ul class="selector time" id="timeSelector6Cpx">
                                ...
                                <li class="value" id="timeCell6Cpx">
                                  <label for="Hours6Cpx"> 启程时间 </label>
                                  <span id="timeCellDropDown6Cpx">
                                  <select id="Hours6Cpx" name="Hours6Cpx" class="simpleBox BeginTime" >
                                    <option value="ANY" selected="selected">任意时间 </option>
                                    <option value="0000">00:00 </option>
                                    <option value="0100">1:00 </option>
                                    <option value="0200">2:00 </option>
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table_B_LOCATION_1" <?php if($setfrom) echo ''; else echo 'style="display: none"'; ?>>
                                      <td nowrap="nowrap"><input name="B_LOCATION_1" id="B_LOCATION_1" _defaultvalue="<?php echo $from; ?>" type="text"
                                        ...
                                        <span class="ImgLookUp" title="单击此处可启动城市弹出窗口" onclick="javascript:etravel.openLocation('B_LOCATION_1');"> &nbsp;</span></td>
                                    </tr>
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                  ...
                                  <tr id="Table_E_LOCATION_1" <?php if($setto) echo ''; else echo 'style="display: none"'; ?>>
                                    <td id="arrivalLocationCell_1" nowrap="nowrap"><input name="E_LOCATION_1" id="E_LOCATION_1" _defaultvalue="<?php echo $to; ?>" type="text"
                                      ...
                                      <span class="ImgLookUp" title="单击此处可启动城市弹出窗口" onclick="javascript:etravel.openLocation('E_LOCATION_1');"> &nbsp;</span></td>
                                  </tr>
                                    </tr>
  ...
  <option value="Others">其它城市(英文或汉语拼音填写)</option>
                    ...
                    <tr style="display:none;">
                      <td class="hide">&nbsp;</td>
                      <td ><span class="spellingLabel">* 如果不确定某个城市或机场的英文拼写，请输入前 3 个或更多字母并加上一个星号 (*)。 </span></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td class="hide">&nbsp;</td>
                        ...
                        <div class="searchDateSelectionPanel" id="divB_DATE1">
                          <ul class="selector date">
                            ...
                            <li class="value" id="DateCmp1">
                              <label for="Month1"> <span class="ImgError" id="WDSErrorImgB_DATE1" style="display: none">&nbsp;</span>启程日期</label>
                              <select name="Month1" id="Month1"  class="simpleBox BeginMonth" onchange="etravel.keepCalendarGap('#divB_DATE1', 7);"
                                                            onkeypress="etravel.keepCalendarGap('#divB_DATE1', 7);">
                              </select>
                              <select id="Day1" name="Day1" class="simpleBox m_day"  onchange="etravel.keepCalendarGap('#divB_DATE1', 7);"
                                                            onkeypress="etravel.keepCalendarGap('#divB_DATE1', 7);">
                              </select>
                              <span id="linkCalendar1" title="单击此处可搜索日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell1" name="originDateDayOfWeekCell1"> </span>
                          ...
                          <ul class="selector time" id="timeSelector1">
                            ...
                            <li class="value" id="timeCell1">
                              <label for="Hours1"> 启程时间 </label>
                              <span id="timeCellDropDown1">
                              <select id="Hours1" name="Hours1"  class="simpleBox BeginTime"   onchange="ADVS.applyTimeWindow('1')">
                                <option value="ANY" selected="selected">任意时间 </option>
                                <option value="0000">00:00 </option>
                                <option value="0100">1:00 </option>
                                <option value="0200">2:00 </option>
                            ...
                            <li class="flexibility" id="TimeWindowCmp1" style="display: none;">
                              <label for="B_TIME_WINDOW_1"> 灵活范围</label>
                          ...
                          <div class="searchDateSelectionPanel" id="divE_DATE2">
                            <ul class="selector date">
                              ...
                              <li class="value" id="DateCmp2">
                                ...
                                <select name="Month2" id="Month2"  class="simpleBox BeginMonth" onchange="etravel.keepCalendarGap('#divE_DATE2', 7);"
                                                                onkeypress="etravel.keepCalendarGap('#divE_DATE2', 7);">
                                </select>
                                <select id="Day2" name="Day2" class="simpleBox m_day" onchange="etravel.keepCalendarGap('#divE_DATE2', 7);"
                                                                onkeypress="etravel.keepCalendarGap('#divE_DATE2', 7);">
                                </select>
                                <span id="linkCalendar2" title="单击此处可搜索日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell2" name="originDateDayOfWeekCell2"> </span>
                            ...
                            <ul class="selector time" id="timeSelector2">
                              ...
                              <li class="value" id="timeCell2">
                                ...
                                <select id="Hours2" name="Hours2" class="simpleBox BeginTime"  onchange="ADVS.applyTimeWindow('2')">
                                  <option value="ANY" selected="selected">任意时间 </option>
                                  <option value="0000">00:00 </option>
                                  <option value="0100">1:00 </option>
                                  <option value="0200">2:00 </option>
                              ...
                              <li class="flexibility" id="TimeWindowCmp2" style="display: none;">
                                <label for="B_TIME_WINDOW_2"> 灵活范围</label>
          ...
          <tr>
            <td width="100" valign="bottom"><table cellpadding="0" cellspacing="0" id="tableTravellers" >
                  ...
                  <td class="textBold" colspan="2"><span class="ImgError" id='WDSErrorImgtableTravellers' style="display: none">&nbsp;</span>旅客 <span class="ImgHelp" id="lnkTraInfo" style="padding-right: 15px" onmouseover="ShowTipsPassengers();"
                    ...
                    <div id="popup1" style="position: absolute; z-index: 2; background-color: #FFFFFF;
                      ...
                      <table border="0" cellspacing="0" cellpadding="0" class="tablePU">
                        <tr>
                          <td class="textBold"> 旅客信息 </td>
                        </tr>
                        <tr>
                          <td style="padding-bottom: 10px"> - 婴儿：两岁以下。<br />
                            - 儿童：两岁至十一岁。<br />
                            - 成人:十二岁及以上。 </td>
                        </tr>
                      </table>
                ...
                <tr id="passengerADTRow" _ispassengercontainer="true">
                  <td style="vertical-align:middle;"> 成人&nbsp; </td>
                  <td style="vertical-align:middle;" id="ADTCell"><select class="simpleBox m_day" name="FIELD_ADT_NUMBER" id="FIELD_ADT_NUMBER">
                ...
                <tr id="passengerCHDRow" _ispassengercontainer="true">
                  <td style="vertical-align:middle;"> 儿童&nbsp; </td>
                  <td style="vertical-align:middle;" id="CHDCell"><select class="simpleBox m_day" name="FIELD_CHD_NUMBER" id="FIELD_CHD_NUMBER">
                ...
                <tr id="passengerINFANTSRow" _ispassengercontainer="true">
                  <td style="vertical-align:middle;"> 婴儿&nbsp;</td>
                  <td style="vertical-align:middle;" id="INFANTSCell"><select class="simpleBox m_day"  name="FIELD_INFANTS_NUMBER" id="FIELD_INFANTS_NUMBER">
                      <option value="0" selected="selected">0</option>
                      <option value="1">1</option>
                      <option value="2">2</option>
                      <option value="3">3</option>
              ...
              <div id="SDComplexCabinDiv">
                <table cellpadding="0" cellspacing="0" id="tablePricingType" style="line-height:35px;">
                  <tr>
                    ...
                    <td class="textBold" style="vertical-align:middle; text-align:right;""> 价格类型:&nbsp; <select class="simpleBox s_year"  name="CABIN" id="cboCabinOption">
                        <option value="F">头等舱</option>
                        <option value="B">商务舱</option>
                        <option value="E" selected="selected">经济舱</option>
                      </select></td>
                      <td>
                      <span class="ImgError" id='WDSErrorImgtablePricingType' style="display: none">&nbsp;</span></td>
                  </tr>
                  <tr>
                    <td nowrap="nowrap" class="textBold" style="vertical-align:middle;text-align:right;"">最高停靠次数:&nbsp;<select class="simpleBox m_day"  name="AIR_MAX_CONNECTIONS" id="AIR_MAX_CONNECTIONS">
                        <option value="0">0</option>
                        <option value="1">1</option>
        ...
        <tr>
            ...
            <table cellpadding="0" cellspacing="0" id="tableTheseAirlinesOnly" style="padding-top:15px;">
                  <tr>
                    <td class="textBold" colspan="2"  style="vertical-align:middle;"><span class="ImgError" id='WDSErrorImgtableTheseAirlinesOnly' style="display: none"></span>指定航空公司: </td>
                    <td nowrap="nowrap" style="vertical-align:middle;"><input name="AIRLINE_1" id="AIRLINE_1" type="text" size="14" maxlength="2" />
                      <span class="ImgLookUp" title="单击此处可启动首选航空公司弹出窗口" onclick="javascript:etravel.openAirLine('AIRLINE_1');"> &nbsp;</span></td>
                  </tr>
                  <tr style="display:none;">
                    <td> 2 </td>
                    <td><input name="AIRLINE_2" id="AIRLINE_2" type="text" size="14" maxlength="2" />
                      <span class="ImgLookUp" title="单击此处可启动首选航空公司弹出窗口" onclick="javascript:etravel.openAirLine('AIRLINE_2');"> &nbsp;</span></td>
                  </tr>
                  <tr style="display:none;">
                    <td> 3 </td>
                    <td><input name="AIRLINE_3" id="AIRLINE_3" type="text" size="14" maxlength="2" />
                      <span class="ImgLookUp" title="单击此处可启动首选航空公司弹出窗口" onclick="javascript:etravel.openAirLine('AIRLINE_3');"> &nbsp;</span></td>
                  </tr>
                </table>
            </td>
          </tr>
          ...
          <tr>
            <td style="text-align:center; vertical-align:bottom; padding-bottom:15px;" ><a href="javascript:ADVS.check();" onclick="return !ADVS.alreadySubmited;" id="btnSearchADVSNFS"><img border="0" src="images/btn_search.jpg" /></a></td>
          </tr>
        </table>
          </td>
  ...
  <table width="100%" cellpadding="0" cellspacing="1" class="tableSearchNavHeader" style="display:none;">
    <tr>
      <td valign="middle" nowrap="nowrap"><span style="font-size:12px; color:red; "><a href="paytype.php" target="_parent" style="color:red;display:none;">United, Continental, All Nippon 及 Delta信用卡支付，需另加3%手续费。</a></span></td>
      <td align="right" style="padding-left:0px;"><div > <a href="javascript:ADVS.check();" onclick="return !ADVS.alreadySubmited;" id="btnSearchADVSNFS"><img border="0" src="images/btn_search.jpg" /></a><span id="btnEdgeSearchADVSNFS"></span></div></td>
    </tr>
  </table>
