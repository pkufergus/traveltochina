						...
						function selectchang()
						{
							...
							document.getElementById("iframe_tjjp").src = "jscpsl_grid.php?lan=0&type="+selvalue+"&time="+TIME;
		                            ...
		                            <tbody>
		                                <tr>
		                                    ...
		                                    <td width="80" align="right" valign="bottom">
		                                    	<span style="font-size:12px;" ><strong>出发月份：</strong></span>
		                                    </td>
		                                    ...
		                                    <td width="130" valign="bottom">
                                                <SELECT style="width:100px; font-size:12px;" name="QUERY_TYPE" id="QUERY_TYPE" onchange=""  >
                                                    <OPTION selected value=0>一周内往返</OPTION>
                                                    <OPTION value=1>两周内往返</OPTION>
                                                    <OPTION value=2>一个月往返</OPTION>
                                                    <OPTION value=3>三个月往返</OPTION>
			                            ...
			                            <tbody>
			                                <tr>
	                                            ...
	                                            <td align="left" style="width: 1000px;padding-top:20px;" valign="top">
                                                    ...
                                                    <iframe src="./jscpsl_grid.php?lan=0" id="iframe_tjjp" name="iframe_tjjp" frameBorder="0" scrolling="no" width="985px"  onLoad="IFrameReSize_tjjp('iframe_tjjp');" ></iframe>                    
                                                </td>
                                                <td width="15px">&nbsp;
	                                            </td>
			                                </tr>
