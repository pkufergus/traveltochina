...
<title>华盛顿至上海特价机票</title>
<meta name="Description" content="www.e-traveltochina.com （美中机票网）以批发价格提供华盛顿至上海特价机票" />
                  ...
                  <table class="border" cellspacing="0" cellpadding="0" style="width: 960px; height: 230px;">
                    ...
                    <tr>
                      <td align="left" style="width: 495px;padding-left:3px;" valign="top"><script type="text/javascript" language="javascript">  
									                  ...
									                  var flighturl = "chinese_from_usa_was_cha.php";
									              </script>
                        <iframe src="chinese_from_usa_was_cha.php" id="iframepage" name="iframepage" frameBorder="0" scrolling="no" width="960px"  onLoad="IFrameReSize('iframepage');" ></iframe></td>
                    </tr>
                  </table></td>
                ...
                <td><?php 
                  ...
                  <script type="text/javascript">
						function selectchang()
						{
							...
							document.getElementById("iframepage_calendar").src = "calendar_6m.php?lan=CN&from="+FROM+"&to="+TO+"&month="+MONTH+"&staydays="+STAYDAYS+"&stops="+STOPS+"&title=华盛顿至上海特价机票";
                  ...
                  <table  cellspacing="0" cellpadding="0" style="width: 100%; height: 300px;">
                    ...
                    <tr height="335px">
                      <td colspan="3" ><iframe src="<?php echo 'calendar_6m.php?lan=CN&from=WAS&to=SHA&stops=0&&staydays=14&title='.urlencode('华盛顿至上海特价机票').'&month='.date('Ym');?>" id="iframepage_calendar" name="iframepage_calendar" frameBorder="0" scrolling="no" width="969px"  height="1070px"></iframe></td>
                    </tr>
                  </table>
                  <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
                    <tbody>
                    ...
                    <tbody>
                      <tr id="tr_right_Chinese">
                        <td colspan="2"><p style="padding-bottom: 18px; margin-top: 0px; padding-left: 20px; width: 850px;line-height:20px;
                                                                margin-bottom: 0px; padding-top: 8px"> <font color="#004483" size="3" face="微软雅黑">美中机票网评论: 上海至华盛顿航班</font></p>
                          ...
                          <p style="padding-bottom: 11px; margin-top: 0px; padding-left: 20px; width: 850px;line-height:20px;
                                                                margin-bottom: 0px; padding-top: 0px"> <font color="#000000" size="2" face="宋体"> 7) 其他线路： 美联航、达尔美(Delta Ailrines)、美利坚(American Airlines)在华盛顿三大机场都可以飞往上海，但需在美国境内中转；也可以搭乘大韩、韩亚、国泰、日航、全日空、加航等在韩国、日本、香港和加拿大中转至上海或中国其他城市；</font></p>
                          <p style="padding-bottom: 11px; margin-top: 0px; padding-left: 20px; width: 850px; line-height:20px;
