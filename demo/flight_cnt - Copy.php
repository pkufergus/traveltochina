                        ...
                        <tr height="335px">
                            <td colspan="3" >
                            <iframe src="<?php  echo 'calendar.php?lan=TW&from=NYC&to=BJS&stops=0&&staydays=7&month='.date('Ym');?>" id="iframepage_calendar" name="iframepage_calendar" frameBorder="0" scrolling="no" width="969px"  height="335px"></iframe> 
                            </td>
                        </tr>
                        <tr>
                            <td>
                     ...
                     <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
                        ...
                        <td align="left" >
                        <a href="./cheap-flights-from-new-york-to-beijing-tw" target="_parent" style="font-size:12px"> 紐約至北京特價機票</a>                      
