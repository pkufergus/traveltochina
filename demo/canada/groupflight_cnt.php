...
<body><a name=FLIGHT></a>
    <div id="maincontainer">
        <?php $aboutForm = 'GROUP';  require("menu_cnt.php");?>
        <div id="content_area">
            <table border="0" cellspacing="0" width="1000px" cellpadding="0" style="vertical-align: text-top;">
            	<tr>
			    	<td valign="top" colspan="2" >
			    		<table class="border_none_top" cellspacing="0" cellpadding="0" style="width: 100%; height: 300px;">
                            <tr>
                                ...
                                <script type="text/javascript" language="javascript">  
                                                    ...
                                                    <iframe src="../groupquery.php" id="iframe_group" name="iframe_group" frameBorder="0" scrolling="no" width="975px"  onLoad="IFrameReSize_group('iframe_group');" ></iframe>                    
