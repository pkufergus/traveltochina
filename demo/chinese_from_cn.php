...
<input type="hidden" name="LANGUAGE" value='CN' /> -->
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table_B_LOCATION_1_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="B_LOCATION_1_Cpx" id="B_LOCATION_1_Cpx" value="Beijing" type="text"
                                                                                                                size="30" />
                                    ...
                                    <tr id="Table2_B_LOCATION_1_Cpx">
                                      <td nowrap="nowrap"><select style="width: 190px;" name="From_B_LOCATION_1_Cpx" id="From_B_LOCATION_1_Cpx"
                                          ...
                                          <option style="font-weight: bold" value="Others">OTHERS CITIES(英文填写任何其他城市或机场）</option>
                                        </select></td>
                                    </tr>
                                ...
                                <td style="padding: 0px;"><input id="backE_LOCATION_1_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table_E_LOCATION_1_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="E_LOCATION_1_Cpx" id="E_LOCATION_1_Cpx" value="Los Angeles" type="text"
                                                                                                                size="30" />
  ...
  <table width="100%" cellpadding="0" cellspacing="1" class="tableSearchNavHeader" style="display:none;">
    <tr>
      ...
      <td align="right" style="padding-left:0px;"><div > <span id="btnEdgeSearchADVSNFS"></span></div></td>
    </tr>
  </table>
    </div>
