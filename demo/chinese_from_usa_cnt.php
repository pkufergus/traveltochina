...
<link rel="stylesheet" type="text/css" href="./css/ADVS1.css" />
...
this.fareTypeLists = eval('({"indexLists":{"MP":"0","SD":"0"},"cabinLists":{"0":[["F","頭等艙"],["B","商務艙"],["E","經濟艙"]]}})');
...
this.timeListArrayTextMP[0]="任何時間";
  ...
  <center>
    <form name="custom">
      <table border="1">
        <tbody>
          <tr>
            <td><b>Requested Segment information 0:</b></td>
            <td> beginLocation
          ...
          <tr>
            <td><b>Requested Segment information 1:</b></td>
            <td> beginLocation
          ...
          <tr>
            ...
            <td><input type="text" name="nbTrav" id="nbTrav" value="9" /></td>
          </tr>
          <tr>
            <td> Cabin : </td>
            <td><input type="text" name="cabin" id="cabin" value="" /></td>
          </tr>
          <tr>
            <td> Language : </td>
            <td><input type="text" name="language" id="language" value='CN' /></td>
          </tr>
          <tr>
            <td> Office Id : </td>
            <td><input type="text" name="officeId" id="officeId" value="LGA1S38AB" /></td>
          </tr>
          <tr>
            <td><b>Agency information:</b></td>
            <td></td>
          </tr>
          <tr>
            <td> Agency email : </td>
            <td><input type="text" name="AgencyEmail" id="AgencyEmail" value="sales@e-traveltochina.com" /></td>
          </tr>
          <tr>
            <td> Agency adress : </td>
            <td></td>
          ...
          <tr>
            ...
            <td><input type="text" name="seatMapSelectionList" id="seatMapSelectionList" value="" />
              <br /></td>
          </tr>
          <tr>
            <td> ext id : </td>
            <td><input type="text" name="cust_external_id" id="cust_external_id" value="" /></td>
          </tr>
          <tr>
            <td> templateName : </td>
            <td><input type="text" name="custom_templateName" id="custom_templateName" value="advs" /></td>
          </tr>
          <tr>
            <td> Portal Environment Variable 1: </td>
            <td><input type="text" name="pe_variable1" id="pe_variable1" value="" /></td>
          </tr>
          <tr>
            <td> Portal Environment Variable 2: </td>
            <td><input type="text" name="pe_variable2" id="pe_variable2" value="" /></td>
          </tr>
          <tr>
            <td> Portal Environment Variable 3: </td>
            <td><input type="text" name="pe_variable3" id="pe_variable3" value="" /></td>
          </tr>
          <tr>
            <td> Portal Environment Variable 4: </td>
            <td><input type="text" name="pe_variable4" id="pe_variable4" value="" /></td>
          </tr>
          <tr>
            <td> Portal Environment Variable 5: </td>
            <td><input type="text" name="pe_variable5" id="pe_variable5" value="" /></td>
          </tr>
          <tr>
            <td> Flex Pricer Mode: </td>
            <td><input type="text" name="flex_pricer_mode" id="flex_pricer_mode" value="" /></td>
          </tr>
          <tr>
            <td> Flex Pricer Page Type: </td>
            <td><input type="text" name="flex_pricer_page_type" id="flex_pricer_page_type" value="" /></td>
          </tr>
      </table>
    </form>
  </center>
...
<center>
  <div id="WDSWaitingImageDivID" style="display: none; align: center;">
    <div id="divWait">
      ...
      <p id="title"> 我們正在處理您的要求，請稍候...</p>
      <p id="indicator"> <img id="WDSProgressImageImgID" alt='我們正在處理您的要求，請稍候...' /></p>
      <p id="info"> </p>
    </div>
  </div>
</center>
...
<table class="layoutTable">
  ...
  <script language="javascript" type="text/javascript">
                        // init messages
                        WDSMessage.setMessage("WDSError.HeaderMessage", "請注意：");
						WDSMessage.setMessage("WDSError.Title.E", "出現以下錯誤");
						WDSMessage.setMessage("WDSError.Title.W", "出現以下警告");
						WDSMessage.setMessage("WDSError.Title.I", "出現以下警告");
						WDSMessage.setMessage("WDSError.Title.F", "出現以下致命錯誤");
                        ...
                        function LocalErrorInit() {
                          ...
                          WDSMessage.setMessage(1040,"%s 是必需填寫的欄位。請輸入 %s。 (1040)"); 
 
							 
							WDSMessage.setMessage(1305,"請驗證輸入的頻繁乘客編號並重試。 (1305)");
							 
							 
							 
							WDSMessage.setMessage(5117,"可用性請求的最大乘客數為 9。 請修改請求的乘客數並重試。 (5117)");
							 
							 
							 
							WDSMessage.setMessage(5118,"供應要求的最大旅客數目為 {0}。請更改您的要求，然後再試一次。 (5118)");
							 
							 
							 
							WDSMessage.setMessage(5121,"每位成人只能攜帶一位嬰兒旅客。 (5121)");
							 
							 
							 
							WDSMessage.setMessage(5122,"兒童不能獨自出行而必須由成人旅客陪伴。 (5122)");
							 
							 
							 
							WDSMessage.setMessage(5123,"請提供一個以上的旅客。 (5123)");
							 
							 
							 
							WDSMessage.setMessage(5124,"嬰兒不能獨自出行而必須由成人旅客陪伴。 (5124)");
							 
							 
							 
							WDSMessage.setMessage(5125,"您不能選擇多於六類的乘客。請修改您的要求並重試。 (5125)");
							 
							 
							 
							WDSMessage.setMessage(5126,"您目前的旅客選擇不符合要求。 嬰幼兒和兒童必須有成年旅客陪伴出行。 (5126)");
							 
							 
							 
							WDSMessage.setMessage(10000,"返程日期/時間同於或早於啟程日期/時間。請調整有關日期/時間並重試。 (10000)");
							 
							 
							 
							WDSMessage.setMessage(10001,"您的啟程城市和抵達城市相同,請重新輸入。 (10001)");
							 
							 
							 
							WDSMessage.setMessage(10004,"請提供啟程城市或機場代碼。 (10004)");
							 
							 
							 
							WDSMessage.setMessage(10005,"請提供到達城市或機場代碼。 (10005)");
							 
							 
							 
							WDSMessage.setMessage(10015,"無法處理您所選擇的航空公司, 請重新輸入。 (10015)");
							 
							 
							 
							WDSMessage.setMessage(10025,"請重新輸入抵達城市。 (10025)");
							 
							 
							 
							WDSMessage.setMessage(10020,"請輸入啟程城市並請重新輸入。 (10020)");
							 
							 
							 
							WDSMessage.setMessage(10031,"出發時間太早。有效時間為^DATA(START_RANGE_NUM)後開始起算的 ^DATA(END_RANGE_NUM)內。請修改日期並重試，或與我們連絡以獲得進一步的資訊。 (10031)");
							 
							 
							 
							WDSMessage.setMessage(10051,"嬰兒不能單獨旅行。此行程中帶有嬰兒，請選取攜帶此嬰兒的旅客姓名旁的嬰兒確認方塊。 (10051)");
							 
							 
							 
							WDSMessage.setMessage(30005,"必須選擇航空公司。請修改輸入的內容並重試。 (30005)");
  ...
  <div id="WDSError" style="display: none">
    <table cellspacing="0" cellpadding="0" class="tableError">
      <tr>
        <td class="textBold" valign="top"><div class="ImgError"> &nbsp;</div></td>
        <td class="textNormal" width="100%"><div id="WDSErrorContainer" class="" /></td>
      </tr>
    </table>
  </div>
  ...
  <form name="ADVSForm" id="ADVSForm" target="_parent" method="post" action="http://wftc1.e-travel.com/plnext/AIEADBLADBL/AvailabilityFlowDispatcher.action?SITE=ADBLADBL&LANGUAGE=TW"
...
<input type="hidden" name="LANGUAGE" value='CN' /> -->
    ...
    <table width="100%" cellspacing="0" cellpadding="0" class="tableSearchDiv">
      <tr>
        <td><div id="rt">
            <ul id="tabnav">
              <li id="roundTripTab" class="t2_selected"><a id="roundTripTabLink" href="javascript:selectRTab();"> 雙程</a> </li>
              <li id="oneWayTab" class="t2_unselected"><a id="oneWayTabLink" href="javascript:selectOTab();"> 單程</a> </li>
              <li id="complexTab" class="t2_unselected"><a id="complexTabLink" href="javascript:selectMTab();"> 多目的地</a>
                <input type="hidden" name="COMPLEX" id="COMPLEX" />
              </li>
            </ul>
            <div class="divTitle" style="display:none;"> 航班</div>
          </div></td>
      </tr>
    </table>
    <table cellspacing="0" cellpadding="0" class="tableSearch">
      ...
      <table cellspacing="0" cellpadding="0" class="tableSearchMain">
        ...
        <td colspan="3"><div id="complexDataId" style="visibility: hidden; display: none; height: 1px;">
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
              <tr style="display:none;">
                <td><span class="textSmaller">* 如果不確定某個城市或機場的拼寫，請輸入前 3 個或更多字母並加上一個星號 (*)。&nbsp;</span></td>
              </tr>
              <tr>
                <td><div class="tableSearchSelect">
                    <div id="divComplexStep_1">
                      <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        ...
                        <tr>
                          <td><div class="divNumbTab"> 1</div></td>
                          <td style="padding: 0px"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                              <tr id="TRB_LOCATION_1_Cpx">
                                <td style="padding: 0px;"><input id="backB_LOCATION_1_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                      <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRB_LOCATION_1_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">始發</span>城市或機場* </td>
                                    </tr>
                                    <tr id="Table_B_LOCATION_1_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="B_LOCATION_1_Cpx" id="B_LOCATION_1_Cpx" value="Los Angeles" type="text"
                                                                                                                size="30" />
                                        <span class="ImgLookUp" title="按一下此處可啟動偏好航空公司快顯視窗" onclick="javascript:etravel.openLocation('B_LOCATION_1_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                                    <tr id="Table2_B_LOCATION_1_Cpx">
                                      <td nowrap="nowrap">
                                        <select style="width: 160px;" name="From_B_LOCATION_1_Cpx" id="From_B_LOCATION_1_Cpx" onchange="selectChange('From_B_LOCATION_1_Cpx','B_LOCATION_1_Cpx')" class="selectable flight">
            	<option value="Los Angeles">洛杉磯(LAX)</option>
	    		<option value="New York" >紐約(NYC)</option>	    		
	    		<option value="San Francisco" class="br">三藩市(SFO)</option>	
	    		<option value="Boston" >波士頓(BOS)</option>
	    		<option value="Chicago">芝加哥(CHI)</option>
	    		<option value="Houston"  class="br">休士頓(HOU)</option>
	    		<option value="Washington">華盛頓(WAS)</option>
	    		<option value="Seattle"  class="br">西雅圖(SEA)</option>
	    		<option value="Others">其它城市(英文填寫)</option>
	    	</select>
                                        
                                        </td>
                                    </tr>
                                    <tr id="SearchRangeDepartureRow_1_Cpx">
                                      <td style="padding: 0px"><div style="padding: 0px; margin: 0px;">
                                          <input style="padding: 0px; margin:  10px 0px 0px 0px;" type="checkbox" name="B_SEARCH_RANGE_1_Cpx"
                                                                                                                id="Departure_Range_1_Cpx" value="100" />
                                          及 100 英里以內的機場 </div></td>
                                    </tr>
                                  </table></td>
                              </tr>
                            </table></td>
                          ...
                          <td style="padding: 0px;"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                              <tr id="TRE_LOCATION_1_Cpx">
                                <td style="padding: 0px;"><input id="backE_LOCATION_1_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                      <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRE_LOCATION_1_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">目的</span>城市或機場* </td>
                                    </tr>
                                    <tr id="Table_E_LOCATION_1_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="E_LOCATION_1_Cpx" id="E_LOCATION_1_Cpx" value="Beijing" type="text"
                                                                                                                size="30" />
                                        </span><span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('E_LOCATION_1_Cpx');"> &nbsp;</span></td>
                                    </tr>
                                    <tr id="Table2_E_LOCATION_1_Cpx">
                                      <td id="departureLocationCell_1" nowrap="nowrap">                                        			
<select style="width: 160px;" name="From_E_LOCATION_1_Cpx" id="From_E_LOCATION_1_Cpx" onchange="selectChange('From_E_LOCATION_1_Cpx','E_LOCATION_1_Cpx')" class="selectable flight">
  <option value="SHA">上海(SHA)</option>
  <option value="BJS">北京(BJS)</option>
  <option value="CAN" class="br">廣州(CAN)</option>
  <option value="FOC">福州(FOC)</option>
  <option value="CTU">成都(CTU)</option>
  <option value="SZX" class="br">深圳(SZX)</option>
  <option value="WNZ">溫州(WNZ)</option>
  <option value="CKG">重慶(CKG)</option>
  <option value="XIY" class="br">西安(XIY)</option>
  <option value="HGH">杭州(HGH)</option>
  <option value="NKG">南京(NKG)</option>
  <option value="WUH" class="br">武漢(WUH)</option>
  <option value="SHE">瀋陽(SHE)</option>
  <option value="KMG">昆明(KMG)</option>
  <option value="XMN" class="br">廈門(XMN)</option>
  <option value="TNA">濟南(TNA)</option>
  <option value="DLC">大連(DLC)</option>
  <option value="TAO" class="br">青島(TAO)</option>
  <option value="CSX">長沙(CSX)</option>
  <option value="CGO">鄭州(CGO)</option>
  <option value="CGQ" class="br">長春(CGQ)</option>
  <option value="HKG">香港(HKG)</option>
  <option value="TPE">臺北(TPE)</option>
  <option value="HRB"class="br">哈爾濱(HRB)</option>
  <option style="font-weight: bold" value="Others">其它城市(英文或漢語拼音填寫)</option>
</select>
                                    ...
                                    <tr id="SearchRangeArrivalRow_1_Cpx">
                                      <td style="padding: 0px"><div style="padding: 0px; margin: 0px;">
                                          <input style="padding: 0px; margin: 10px 0px 0px 0px;" type="checkbox" name="E_SEARCH_RANGE_1_Cpx"
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td style="padding: 0px" colspan="3"><!-- Search date selection panel (1Cpx) -->
                            ...
                            <div class="searchDateSelectionPanel" id="divB_DATE1Cpx">
                              <ul class="selector date">
                                ...
                                <li class="value" id="DateCmp1Cpx">
                                  <label for="Month1Cpx"> <span class="ImgError" id="WDSErrorImgB_DATE1Cpx" style="display: none">&nbsp;</span>啟程日期</label>
                                  <select name="Month1Cpx"  class="simpleBox BeginMonth"  id="Month1Cpx" onchange="etravel.keepCalendarGap('#divB_DATE1Cpx', 7);"
                                                                                                onkeypress="etravel.keepCalendarGap('#divB_DATE1Cpx', 7);">
                                  </select>
                                  <select id="Day1Cpx" class="simpleBox m_day"  name="Day1Cpx" onchange="etravel.keepCalendarGap('#divB_DATE1Cpx', 7);"
                                                                                                onkeypress="etravel.keepCalendarGap('#divB_DATE1Cpx', 7);">
                                  </select>
                                  <span id="linkCalendar1Cpx" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell1Cpx" name="originDateDayOfWeekCell1Cpx"> </span>
                              ...
                              <ul class="selector time" id="timeSelector1Cpx">
                                ...
                                <li class="value" id="timeCell1Cpx">
                                  <label for="Hours1Cpx"> 出發時間 </label>
                                  <span id="timeCellDropDown1Cpx">
                                  <select id="Hours1Cpx"  class="simpleBox BeginTime" name="Hours1Cpx">
                                    <option value="ANY" selected="selected">任何時間 </option>
                            ...
                            <!-- End of search date selection panel --></td>
                          <td class="hide">&nbsp;</td>
                        </tr>
                      </table>
                    </div>
                    <div id="divComplexStep_2">
                      <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                          <td colspan="4" style="padding: 0px" class="lineSeparatorPassenger">&nbsp;</td>
                          <td class="hide">&nbsp;</td>
                        </tr>
                        <tr>
                          <td colspan="4">&nbsp;</td>
                        ...
                        <tr>
                          <td><div class="divNumbTab"> 2</div></td>
                          <td style="padding: 0px"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                              <tr id="TRB_LOCATION_2_Cpx">
                                <td style="padding: 0px;"><input id="backB_LOCATION_2_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                      <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRB_LOCATION_2_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">始發</span>城市或機場* </td>
                                    </tr>
                                    <tr id="Table_B_LOCATION_2_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="B_LOCATION_2_Cpx" id="B_LOCATION_2_Cpx" type="text" size="30" />
                                        <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('B_LOCATION_2_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                                    <tr id="Table2_B_LOCATION_2_Cpx">
                                      <td nowrap="nowrap">
                                        <select  style="width: 160px;" name="From_B_LOCATION_2_Cpx" id="From_B_LOCATION_2_Cpx" onchange="selectChange('From_B_LOCATION_2_Cpx','B_LOCATION_2_Cpx')" class="selectable flight">
            	<option value="Los Angeles">洛杉磯(LAX)</option>
	    		<option value="New York" >紐約(NYC)</option>	    		
	    		<option value="San Francisco" class="br">三藩市(SFO)</option>	
	    		<option value="Boston" >波士頓(BOS)</option>
	    		...
	    		<option value="Houston"  class="br">休士頓(HOU)</option>
	    		<option value="Washington">華盛頓(WAS)</option>
	    		<option value="Seattle" >西雅圖(SEA)</option>
                <option value=""  class="br" selected="selected"></option>
	    		<option value="Others">其它城市(英文填寫)</option>
                                    ...
                                    <tr id="SearchRangeDepartureRow_2_Cpx">
                                      <td style="padding: 0px"><div style="padding: 0px; margin: 0px;">
                                          <input style="padding: 0px; margin:  10px 0px 0px 0px;" type="checkbox" name="B_SEARCH_RANGE_2_Cpx"
                          ...
                          <td style="padding: 0px;"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                              <tr id="TRE_LOCATION_2_Cpx">
                                <td style="padding: 0px;"><input id="backE_LOCATION_2_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                      <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRE_LOCATION_2_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">目的</span>城市或機場* </td>
                                    </tr>
                                    <tr id="Table_E_LOCATION_2_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="E_LOCATION_2_Cpx" id="E_LOCATION_2_Cpx" type="text" size="30" />
                                        <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('E_LOCATION_2_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                                    <tr id="Table2_E_LOCATION_2_Cpx">
                                      <td nowrap="nowrap">
                                        <select  style="width: 160px;" name="From_E_LOCATION_2_Cpx" id="From_E_LOCATION_2_Cpx" onchange="selectChange('From_E_LOCATION_2_Cpx','E_LOCATION_2_Cpx')" class="selectable flight">
  <option value=""  class="br" selected="selected"></option>
    <option value="SHA">上海(SHA)</option>
  <option value="BJS">北京(BJS)</option>
  <option value="CAN" class="br">廣州(CAN)</option>
  ...
  <option style="font-weight: bold" value="Others">其它城市(英文或漢語拼音填寫)</option>
                                    ...
                                    <tr id="SearchRangeArrivalRow_2_Cpx">
                                      <td style="padding: 0px"><div style="padding: 0px; margin: 0px;">
                                          <input style="padding: 0px; margin: 10px 0px 0px 0px;" type="checkbox" name="E_SEARCH_RANGE_2_Cpx"
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td style="padding: 0px" colspan="3"><!-- Search date selection panel (2Cpx) -->
                            
                            <div class="searchDateSelectionPanel" id="divB_DATE2Cpx">
                              <ul class="selector date">
                                <!-- First selection: date (month and day) -->
                                <li class="value" id="DateCmp2Cpx">
                                  <label for="Month2Cpx"> <span class="ImgError" id="WDSErrorImgB_DATE2Cpx" style="display: none">&nbsp;</span>啟程日期</label>
                                  <select name="Month2Cpx" class="simpleBox BeginMonth"  id="Month2Cpx" onchange="etravel.keepCalendarGap('#divB_DATE2Cpx', 7);"
                                                                                                onkeypress="etravel.keepCalendarGap('#divB_DATE2Cpx', 7);">
                                  </select>
                                  <select id="Day2Cpx" class="simpleBox m_day"  name="Day2Cpx" onchange="etravel.keepCalendarGap('#divB_DATE2Cpx', 7);"
                                                                                                onkeypress="etravel.keepCalendarGap('#divB_DATE2Cpx', 7);">
                                  </select>
                                  <span id="linkCalendar2Cpx" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell2Cpx" name="originDateDayOfWeekCell2Cpx"> </span>
                              ...
                              <ul class="selector time" id="timeSelector2Cpx">
                                ...
                                <li class="value" id="timeCell2Cpx">
                                  <label for="Hours2Cpx"> 出發時間 </label>
                                  <span id="timeCellDropDown2Cpx">
                                  <select id="Hours2Cpx" class="simpleBox BeginTime"  name="Hours2Cpx">
                                    <option value="ANY" selected="selected">任何時間 </option>
                                    <option value="0000">00:00 </option>
                                    <option value="0100">1:00 </option>
                                    <option value="0200">2:00 </option>
                    ...
                    <div id="divComplexStep_3">
                      <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        ...
                        <tr>
                          <td><div class="divNumbTab"> 3</div></td>
                          <td style="padding: 0px"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                              <tr id="TRB_LOCATION_3_Cpx">
                                <td style="padding: 0px;"><input id="backB_LOCATION_3_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                      <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRB_LOCATION_3_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">始發</span>城市或機場* </td>
                                    </tr>
                                    <tr id="Table_B_LOCATION_3_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="B_LOCATION_3_Cpx" id="B_LOCATION_3_Cpx" type="text" size="30" />
                                        <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('B_LOCATION_3_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                                    <tr id="Table2_B_LOCATION_3_Cpx">
                                      <td nowrap="nowrap">
                                        <select  style="width: 160px;" name="From_B_LOCATION_3_Cpx" id="From_B_LOCATION_3_Cpx" onchange="selectChange('From_B_LOCATION_3_Cpx','B_LOCATION_3_Cpx')" class="selectable flight">
            	<option value="Los Angeles">洛杉磯(LAX)</option>
	    		<option value="New York" >紐約(NYC)</option>	    		
	    		<option value="San Francisco" class="br">三藩市(SFO)</option>	
	    		<option value="Boston" >波士頓(BOS)</option>
	    		...
	    		<option value="Others">其它城市(英文填寫)</option>
                                    ...
                                    <tr id="SearchRangeDepartureRow_3_Cpx">
                                      <td style="padding: 0px"><div style="padding: 0px; margin: 0px;">
                                          <input style="padding: 0px; margin:  10px 0px 0px 0px;" type="checkbox" name="B_SEARCH_RANGE_3_Cpx"
                          ...
                          <td style="padding: 0px;"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                              <tr id="TRE_LOCATION_3_Cpx">
                                <td style="padding: 0px;"><input id="backE_LOCATION_3_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                      <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRE_LOCATION_3_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">目的</span>城市或機場* </td>
                                    </tr>
                                    <tr id="Table_E_LOCATION_3_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="E_LOCATION_3_Cpx" id="E_LOCATION_3_Cpx" type="text" size="30" />
                                        <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('E_LOCATION_3_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                                    <tr id="Table2_E_LOCATION_3_Cpx">
                                      <td nowrap="nowrap">	
<select style="width: 160px;" name="From_E_LOCATION_3_Cpx" id="From_E_LOCATION_3_Cpx" onchange="selectChange('From_E_LOCATION_3_Cpx','E_LOCATION_3_Cpx')" class="selectable flight">
  <option value=""  class="br" selected="selected"></option>
    <option value="SHA">上海(SHA)</option>
  <option value="BJS">北京(BJS)</option>
  <option value="CAN" class="br">廣州(CAN)</option>
  ...
  <option style="font-weight: bold" value="Others">其它城市(英文或漢語拼音填寫)</option>
                                    ...
                                    <tr id="SearchRangeArrivalRow_3_Cpx">
                                      <td style="padding: 0px"><div style="padding: 0px; margin: 0px;">
                                          <input style="padding: 0px; margin: 10px 0px 0px 0px;" type="checkbox" name="E_SEARCH_RANGE_3_Cpx"
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td style="padding: 0px" colspan="3"><!-- Search date selection panel (3Cpx) -->
                            
                            <div class="searchDateSelectionPanel" id="divB_DATE3Cpx">
                              <ul class="selector date">
                                <!-- First selection: date (month and day) -->
                                <li class="value" id="DateCmp3Cpx">
                                  <label for="Month3Cpx"> <span class="ImgError" id="WDSErrorImgB_DATE3Cpx" style="display: none">&nbsp;</span>啟程日期</label>
                                  <select name="Month3Cpx"  class="simpleBox BeginMonth" id="Month3Cpx" onchange="etravel.keepCalendarGap('#divB_DATE3Cpx', 7);"
                                                                                                onkeypress="etravel.keepCalendarGap('#divB_DATE3Cpx', 7);">
                                  </select>
                                  <select id="Day3Cpx" class="simpleBox m_day"  name="Day3Cpx" onchange="etravel.keepCalendarGap('#divB_DATE3Cpx', 7);"
                                                                                                onkeypress="etravel.keepCalendarGap('#divB_DATE3Cpx', 7);">
                                  </select>
                                  <span id="linkCalendar3Cpx" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell3Cpx" name="originDateDayOfWeekCell3Cpx"> </span>
                              ...
                              <ul class="selector time" id="timeSelector3Cpx">
                                ...
                                <li class="value" id="timeCell3Cpx">
                                  <label for="Hours3Cpx"> 出發時間 </label>
                                  <span id="timeCellDropDown3Cpx">
                                  <select id="Hours3Cpx" class="simpleBox BeginTime" name="Hours3Cpx">
                                    <option value="ANY" selected="selected">任何時間 </option>
                                    <option value="0000">00:00 </option>
                                    <option value="0100">1:00 </option>
                                    <option value="0200">2:00 </option>
                    ...
                    <div id="divComplexStep_4" style="display: none;">
                      <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        ...
                        <tr>
                          <td><div class="divNumbTab"> 4</div></td>
                          <td style="padding: 0px"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                              <tr id="TRB_LOCATION_4_Cpx">
                                <td style="padding: 0px;"><input id="backB_LOCATION_4_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                      <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRB_LOCATION_4_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">始發</span>城市或機場* </td>
                                    </tr>
                                    <tr id="Table_B_LOCATION_4_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="B_LOCATION_4_Cpx" id="B_LOCATION_4_Cpx" type="text" size="30" />
                                        <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('B_LOCATION_4_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                                    <tr id="Table2_B_LOCATION_4_Cpx">
                                      <td nowrap="nowrap"><select style="width: 160px;" name="From_B_LOCATION_4_Cpx" id="From_B_LOCATION_4_Cpx"
	    		...
	    		<option value="Washington">華盛頓(WAS)</option>
	    		<option value="Seattle"  class="br">西雅圖(SEA)</option>
                                          <option style="font-weight: bold" value="Others">其它城市(英文填寫)</option>
                                        </select></td>
                                    </tr>
                                    <tr id="SearchRangeDepartureRow_4_Cpx">
                                      <td style="padding: 0px"><div style="padding: 0px; margin: 0px;">
                                          <input style="padding: 0px; margin: 10px 0px 0px 0px;" type="checkbox" name="B_SEARCH_RANGE_4_Cpx"
                          ...
                          <td style="padding: 0px;"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                              <tr id="TRE_LOCATION_4_Cpx">
                                <td style="padding: 0px;"><input id="backE_LOCATION_4_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                      <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRE_LOCATION_4_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">目的</span>城市或機場* </td>
                                    </tr>
                                    <tr id="Table_E_LOCATION_4_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="E_LOCATION_4_Cpx" id="E_LOCATION_4_Cpx" type="text" size="30" />
                                        <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('E_LOCATION_4_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                                    <tr id="Table2_E_LOCATION_4_Cpx">
                                      <td nowrap="nowrap"><select style="width: 160px;" name="From_E_LOCATION_4_Cpx" id="From_E_LOCATION_4_Cpx"
                                    ...
                                    <tr id="SearchRangeArrivalRow_4_Cpx">
                                      <td style="padding: 0px"><div style="padding: 0px; margin: 0px;">
                                          <input style="padding: 0px; margin: 10px 0px 0px 0px;" type="checkbox" name="E_SEARCH_RANGE_4_Cpx"
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td style="padding: 0px" colspan="3"><!-- Search date selection panel (4Cpx) -->
                            
                            <div class="searchDateSelectionPanel" id="divB_DATE4Cpx">
                              <ul class="selector date">
                                <!-- First selection: date (month and day) -->
                                <li class="value" id="DateCmp4Cpx">
                                  <label for="Month4Cpx"> <span class="ImgError" id="WDSErrorImgB_DATE4Cpx" style="display: none">&nbsp;</span>啟程日期</label>
                                  <select name="Month4Cpx"  class="simpleBox BeginMonth"  id="Month4Cpx" onchange="etravel.keepCalendarGap('#divB_DATE4Cpx', 7);"
                                                                                                onkeypress="etravel.keepCalendarGap('#divB_DATE4Cpx', 7);">
                                  </select>
                                  <select id="Day4Cpx" class="simpleBox m_day"  name="Day4Cpx" onchange="etravel.keepCalendarGap('#divB_DATE4Cpx', 7);"
                                                                                                onkeypress="etravel.keepCalendarGap('#divB_DATE4Cpx', 7);">
                                  </select>
                                  <span id="linkCalendar4Cpx" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell4Cpx" name="originDateDayOfWeekCell4Cpx"> </span>
                              ...
                              <ul class="selector time" id="timeSelector4Cpx">
                                ...
                                <li class="value" id="timeCell4Cpx">
                                  <label for="Hours4Cpx"> 出發時間 </label>
                                  <span id="timeCellDropDown4Cpx">
                                  <select id="Hours4Cpx" class="simpleBox BeginTime"  name="Hours4Cpx">
                                    <option value="ANY" selected="selected">任何時間 </option>
                                    <option value="0000">00:00 </option>
                                    <option value="0100">1:00 </option>
                                    <option value="0200">2:00 </option>
                    ...
                    <div id="divComplexStep_5" style="display: none;">
                      <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        ...
                        <tr>
                          <td><div class="divNumbTab"> 5</div></td>
                          <td style="padding: 0px"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                              <tr id="TRB_LOCATION_5_Cpx">
                                <td style="padding: 0px;"><input id="backB_LOCATION_5_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                      <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRB_LOCATION_5_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">始發</span>城市或機場* </td>
                                    </tr>
                                    <tr id="Table_B_LOCATION_5_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="B_LOCATION_5_Cpx" id="B_LOCATION_5_Cpx" type="text" size="30" />
                                        <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('B_LOCATION_5_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                                    <tr id="Table2_B_LOCATION_5_Cpx">
                                      <td nowrap="nowrap"><select style="width: 160px;" name="From_B_LOCATION_5_Cpx" id="From_B_LOCATION_5_Cpx"
	    		...
	    		<option value="Seattle"  class="br">西雅圖(SEA)</option>
                                    ...
                                    <tr id="SearchRangeDepartureRow_5_Cpx">
                                      <td style="padding: 0px"><div style="padding: 0px; margin: 0px;">
                                          <input style="padding: 0px; margin: 10px 0px 0px 0px;" type="checkbox" name="B_SEARCH_RANGE_5_Cpx"
                          ...
                          <td style="padding: 0px;"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                              <tr id="TRE_LOCATION_5_Cpx">
                                <td style="padding: 0px;"><input id="backE_LOCATION_5_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                      <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRE_LOCATION_5_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">目的</span>城市或機場* </td>
                                    </tr>
                                    <tr id="Table_E_LOCATION_5_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="E_LOCATION_5_Cpx" id="E_LOCATION_5_Cpx" type="text" size="30" />
                                        <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('E_LOCATION_5_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                                    <tr id="Table2_E_LOCATION_5_Cpx">
                                      <td nowrap="nowrap"><select style="width: 160px;" name="From_E_LOCATION_5_Cpx" id="From_E_LOCATION_5_Cpx"
                                    ...
                                    <tr id="SearchRangeArrivalRow_5_Cpx">
                                      <td style="padding: 0px"><div style="padding: 0px; margin: 0px;">
                                          <input style="padding: 0px; margin: 10px 0px 0px 0px;" type="checkbox" name="E_SEARCH_RANGE_5_Cpx"
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td style="padding: 0px" colspan="3"><!-- Search date selection panel (5Cpx) -->
                            
                            <div class="searchDateSelectionPanel" id="divB_DATE5Cpx">
                              <ul class="selector date">
                                <!-- First selection: date (month and day) -->
                                <li class="value" id="DateCmp5Cpx">
                                  <label for="Month5Cpx"> <span class="ImgError" id="WDSErrorImgB_DATE5Cpx" style="display: none">&nbsp;</span>啟程日期</label>
                                  <select name="Month5Cpx"  class="simpleBox BeginMonth" id="Month5Cpx" onchange="etravel.keepCalendarGap('#divB_DATE5Cpx', 7);"
                                                                                                onkeypress="etravel.keepCalendarGap('#divB_DATE5Cpx', 7);">
                                  </select>
                                  <select id="Day5Cpx" class="simpleBox m_day"  name="Day5Cpx" onchange="etravel.keepCalendarGap('#divB_DATE5Cpx', 7);"
                                                                                                onkeypress="etravel.keepCalendarGap('#divB_DATE5Cpx', 7);">
                                  </select>
                                  <span id="linkCalendar5Cpx" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell5Cpx" name="originDateDayOfWeekCell5Cpx"> </span>
                              ...
                              <ul class="selector time" id="timeSelector5Cpx">
                                ...
                                <li class="value" id="timeCell5Cpx">
                                  <label for="Hours5Cpx"> 出發時間 </label>
                                  <span id="timeCellDropDown5Cpx">
                                  <select id="Hours5Cpx"  class="simpleBox BeginTime" name="Hours5Cpx">
                                    <option value="ANY" selected="selected">任何時間 </option>
                                    <option value="0000">00:00 </option>
                                    <option value="0100">1:00 </option>
                                    <option value="0200">2:00 </option>
                    ...
                    <div id="divComplexStep_6" style="display: none;">
                      <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        ...
                        <tr>
                          <td><div class="divNumbTab"> 6</div></td>
                          <td style="padding: 0px"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                              <tr id="TRB_LOCATION_6_Cpx">
                                <td style="padding: 0px;"><input id="backB_LOCATION_6_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                      <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRB_LOCATION_6_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">始發</span>城市或機場* </td>
                                    </tr>
                                    <tr id="Table_B_LOCATION_6_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="B_LOCATION_6_Cpx" id="B_LOCATION_6_Cpx" type="text" size="30" />
                                        <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('B_LOCATION_6_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                                    <tr id="Table2_B_LOCATION_6_Cpx">
                                      <td nowrap="nowrap"><select style="width: 160px;" name="From_B_LOCATION_6_Cpx" id="From_B_LOCATION_6_Cpx"
	    		...
	    		<option value="Seattle"  class="br">西雅圖(SEA)</option>
                                    ...
                                    <tr id="SearchRangeDepartureRow_6_Cpx">
                                      <td style="padding: 0px"><div style="padding: 0px; margin: 0px;">
                                          <input style="padding: 0px; margin: 10px 0px 0px 0px;" type="checkbox" name="B_SEARCH_RANGE_6_Cpx"
                          ...
                          <td style="padding: 0px;"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                              <tr id="TRE_LOCATION_6_Cpx">
                                <td style="padding: 0px;"><input id="backE_LOCATION_6_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                      <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRE_LOCATION_6_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">目的</span>城市或機場* </td>
                                    </tr>
                                    <tr id="Table_E_LOCATION_6_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="E_LOCATION_6_Cpx" id="E_LOCATION_6_Cpx" type="text" size="30" />
                                        <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('E_LOCATION_6_Cpx');"> &nbsp;</span> </span></td>
                                    </tr>
                                    <tr id="Table2_E_LOCATION_6_Cpx">
                                      <td nowrap="nowrap"><select style="width: 160px;" name="From_E_LOCATION_6_Cpx" id="From_E_LOCATION_6_Cpx"
                                    ...
                                    <tr id="SearchRangeArrivalRow_6_Cpx">
                                      <td style="padding: 0px"><div style="padding: 0px; margin: 0px;">
                                          <input style="padding: 0px; margin: 10px 0px 0px 0px;" type="checkbox" name="E_SEARCH_RANGE_6_Cpx"
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td style="padding: 0px" colspan="3"><!-- Search date selection panel (6Cpx) -->
                            
                            <div class="searchDateSelectionPanel" id="divB_DATE6Cpx">
                              <ul class="selector date">
                                <!-- First selection: date (month and day) -->
                                <li class="value" id="DateCmp6Cpx">
                                  <label for="Month6Cpx"> <span class="ImgError" id="WDSErrorImgB_DATE6Cpx" style="display: none">&nbsp;</span>啟程日期</label>
                                  <select name="Month6Cpx"  class="simpleBox BeginMonth" id="Month6Cpx" onchange="etravel.keepCalendarGap('#divB_DATE6Cpx', 7);"
                                                                                                onkeypress="etravel.keepCalendarGap('#divB_DATE6Cpx', 7);">
                                  </select>
                                  <select id="Day6Cpx" class="simpleBox m_day"  name="Day6Cpx" onchange="etravel.keepCalendarGap('#divB_DATE6Cpx', 7);"
                                                                                                onkeypress="etravel.keepCalendarGap('#divB_DATE6Cpx', 7);">
                                  </select>
                                  <span id="linkCalendar6Cpx" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell6Cpx" name="originDateDayOfWeekCell6Cpx"> </span>
                              ...
                              <ul class="selector time" id="timeSelector6Cpx">
                                ...
                                <li class="value" id="timeCell6Cpx">
                                  <label for="Hours6Cpx"> 出發時間 </label>
                                  <span id="timeCellDropDown6Cpx">
                                  <select id="Hours6Cpx"  class="simpleBox BeginTime" name="Hours6Cpx">
                                    <option value="ANY" selected="selected">任何時間 </option>
                                    <option value="0000">00:00 </option>
                                    <option value="0100">1:00 </option>
                                    <option value="0200">2:00 </option>
          ...
          <div id="nonComplexPanelTr">
            <table cellspacing="0" cellpadding="0">
              <tr>
                <td><table cellspacing="0" cellpadding="0" class="tableSearchSelect">
                    <tr>
                      <td class="hide">&nbsp;</td>
                      <td width="100%">&nbsp;</td>
                      <td>&nbsp;</td>
                    ...
                    <td class="hide">&nbsp;</td>
                    <td style="padding: 0px"><div class="searchLocationsSelectionPanel">
                        <table cellspacing="0" cellpadding="0" width="100%" border="0" id="tableLOCATION_1">
                            <tr>
                          
                          <td style="padding: 0px"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                              <tr id="TRB_LOCATION_1">
                                <td style="padding: 0px;"><input id="backB_LOCATION_1" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                      <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRB_LOCATION_1" style="display: none">&nbsp;</span><span
                                                                                                                    class="textBold">始發</span>城市或機場* </td>
                                    </tr>
                                    <tr id="Table_B_LOCATION_1" <?php if($setfrom) echo ''; else echo 'style="display: none"'; ?> >
                                      <td nowrap="nowrap"><input name="B_LOCATION_1" id="B_LOCATION_1" _defaultvalue="<?php echo $from; ?>" type="text"
                                                                                                                    size="30" value="<?php echo $from; ?>" />
                                        <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('B_LOCATION_1');"> &nbsp;</span></td>
                                    </tr>
                                    <tr id="Table2_B_LOCATION_1" <?php if(!$setfrom) echo ''; else echo 'style="display: none"'; ?>>
                                      <td nowrap="nowrap">
                                        <select style="width: 160px;" name="From_B_LOCATION_1" id="From_B_LOCATION_1" onchange="selectChange('From_B_LOCATION_1','B_LOCATION_1')" class="selectable flight">
            	<option value="Los Angeles">洛杉磯(LAX)</option>
	    		<option value="New York" >紐約(NYC)</option>	    		
	    		<option value="San Francisco" class="br">三藩市(SFO)</option>	
	    		<option value="Boston" >波士頓(BOS)</option>
	    		...
	    		<option value="Others">其它城市(英文填寫)</option>
                                    ...
                                    <tr id="SearchRangeDepartureRow_1">
                                      <td style="padding: 0px"><div style="padding: 0px; margin: 0px;">
                                          <input style="padding: 0px; margin: 10px 0px 0px 0px;" type="checkbox" name="B_SEARCH_RANGE_1"
                          ...
                          <td style="padding: 0px"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                              ...
                              <td style="padding: 0px;"><input id="backE_LOCATION_1" type="hidden" />
                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                  <tr>
                                    <td style="padding: 0px;"><span class="ImgError" id="WDSErrorImgTRE_LOCATION_1" style="display: none">&nbsp;</span><span
                                                                                                                    class="textBold">目的</span>城市或機場* </td>
                                  </tr>
                                  <tr id="Table_E_LOCATION_1" <?php if($setto) echo ''; else echo 'style="display: none"'; ?>>
                                    <td id="arrivalLocationCell_1" nowrap="nowrap"><input name="E_LOCATION_1" id="E_LOCATION_1" _defaultvalue="<?php echo $to; ?>" type="text"
                                                                                                                    size="30" value="<?php echo $to; ?>" />
                                      <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('E_LOCATION_1');"> &nbsp;</span></td>
                                  </tr>
                                    </tr>
                                  
                                  <tr id="Table2_E_LOCATION_1" <?php if(!$setto) echo ''; else echo 'style="display: none"'; ?>>
                                    <td nowrap="nowrap">
<select   style="width: 160px;" name="From_E_LOCATION_1" id="From_E_LOCATION_1" onchange="selectChange('From_E_LOCATION_1','E_LOCATION_1')" class="selectable flight">
  <option value="SHA">上海(SHA)</option>
  <option value="BJS">北京(BJS)</option>
  <option value="CAN" class="br">廣州(CAN)</option>
  <option value="FOC">福州(FOC)</option>
  ...
  <option style="font-weight: bold" value="Others">其它城市(英文或漢語拼音填寫)</option>
                                  ...
                                  <tr id="SearchRangeArrivalRow_1">
                                    <td style="padding: 0px;"><div style="padding: 0px; margin: 0px;">
                                        <input style="padding: 0px; margin: 10px 0px 0px 0px;" type="checkbox" name="E_SEARCH_RANGE_1"
                    ...
                    <tr>
                      <td class="space hide"></td>
                    </tr>
                    <tr style="display:none;">
                      <td class="hide">&nbsp;</td>
                      <td ><span class="spellingLabel">* 如果不確定某個城市或機場的拼寫，請輸入前 3 個或更多字母並加上一個星號 (*)。 </span></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td class="hide">&nbsp;</td>
                    ...
                    <tr>
                      <td class="hide">&nbsp;</td>
                      <td style="padding: 0px"><!-- Search date selection panel (1) -->
                        
                        <div class="searchDateSelectionPanel" id="divB_DATE1">
                          <ul class="selector date">
                            <!-- First selection: date (month and day) -->
                            <li class="value" id="DateCmp1">
                              <label for="Month1"> <span class="ImgError" id="WDSErrorImgB_DATE1" style="display: none">&nbsp;</span>啟程日期</label>
                              <select name="Month1"  class="simpleBox BeginMonth" id="Month1" onchange="etravel.keepCalendarGap('#divB_DATE1', 7);"
                                                            onkeypress="etravel.keepCalendarGap('#divB_DATE1', 7);">
                              </select>
                              <select id="Day1" class="simpleBox m_day"  name="Day1" onchange="etravel.keepCalendarGap('#divB_DATE1', 7);"
                                                            onkeypress="etravel.keepCalendarGap('#divB_DATE1', 7);">
                              </select>
                              <span id="linkCalendar1" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell1" name="originDateDayOfWeekCell1"> </span>
                          ...
                          <ul class="selector time" id="timeSelector1">
                            ...
                            <li class="value" id="timeCell1">
                              <label for="Hours1"> 出發時間 </label>
                              <span id="timeCellDropDown1">
                              <select id="Hours1" class="simpleBox BeginTime"  name="Hours1" onchange="ADVS.applyTimeWindow('1')">
                                <option value="ANY" selected="selected">任何時間 </option>
                                <option value="0000">00:00 </option>
                                <option value="0100">1:00 </option>
                                <option value="0200">2:00 </option>
                            ...
                            <li class="flexibility" id="TimeWindowCmp1" style="display: none;">
                              <label for="B_TIME_WINDOW_1"> 靈活範圍</label>
                              <select name="B_TIME_WINDOW_1" id="B_TIME_WINDOW_1">
                                <option value="">全部顯示</option>
                                <option value="1">+/- 1 小時 </option>
                                <option value="2" selected="selected">+/- 2 小時 </option>
                          ...
                          <div class="searchDateSelectionPanel" id="divE_DATE2">
                            <ul class="selector date">
                              ...
                              <li class="value" id="DateCmp2">
                                <label for="Month2"> <span class="ImgError" id="WDSErrorImgE_DATE2" style="display: none">&nbsp;</span>返程日期</label>
                                <select name="Month2" class="simpleBox BeginMonth"  id="Month2" onchange="etravel.keepCalendarGap('#divE_DATE2', 7);"
                                                                onkeypress="etravel.keepCalendarGap('#divE_DATE2', 7);">
                                </select>
                                <select id="Day2" class="simpleBox m_day"  name="Day2" onchange="etravel.keepCalendarGap('#divE_DATE2', 7);"
                                                                onkeypress="etravel.keepCalendarGap('#divE_DATE2', 7);">
                                </select>
                                <span id="linkCalendar2" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span class="dayOfWeek" id="originDateDayOfWeekCell2" name="originDateDayOfWeekCell2"> </span>
                            ...
                            <ul class="selector time" id="timeSelector2">
                              ...
                              <li class="value" id="timeCell2">
                                <label for="Hours2"> 返程时间 </label>
                                <span id="timeCellDropDown2">
                                <select id="Hours2" class="simpleBox BeginTime"  name="Hours2" onchange="ADVS.applyTimeWindow('2')">
                                  <option value="ANY" selected="selected">任何時間 </option>
                                  <option value="0000">00:00 </option>
                                  <option value="0100">1:00 </option>
                                  <option value="0200">2:00 </option>
                              ...
                              <li class="flexibility" id="TimeWindowCmp2" style="display: none;">
                                <label for="B_TIME_WINDOW_2"> 靈活範圍</label>
                    ...
                    <tr>
                      <td class="hide">&nbsp;</td>
                      <td style="padding: 0px" class="hideLine">&nbsp;</td>
                      <td>&nbsp;</td>
                    </tr>
                  </table></td>
              </tr>
        ...
        <table cellpadding="0" cellspacing="0" width="310px" >
          ...
          <tr>
            <td width="100" valign="bottom"><table cellpadding="0" cellspacing="0" id="tableTravellers">
                <tr>
                  <td class="textBold" colspan="2"><span class="ImgError" id='WDSErrorImgtableTravellers' style="display: none">&nbsp;</span>旅客 <span class="ImgHelp" id="lnkTraInfo" style="padding-right: 15px" onmouseover="ShowTipsPassengers();"
                    ...
                    <div id="popup1" style="position: absolute; z-index: 2; background-color: #FFFFFF;
                      ...
                      <table border="0" cellspacing="0" cellpadding="0" class="tablePU">
                        <tr>
                          <td class="textBold"> 旅客資訊 </td>
                        </tr>
                        <tr>
                          <td style="padding-bottom: 10px"> - 嬰兒:兩歲以下。<br />
                            - 兒童:兩歲至十一歲。<br />
                            - 成人:十二歲及以上。 </td>
                        </tr>
                      </table>
                ...
                <tr id="passengerADTRow" _ispassengercontainer="true">
                  <td> 成人 </td>
                  <td id="ADTCell"><select name="FIELD_ADT_NUMBER"  class="simpleBox m_day" id="FIELD_ADT_NUMBER">
                    ...
                    <input type="hidden" name="ALLOW_PRIMARY_ADT" id="ALLOW_PRIMARY_ADT" value="Y" /></td>
                </tr>
                <tr id="passengerCHDRow" _ispassengercontainer="true">
                  <td> 兒童 </td>
                  <td id="CHDCell"><select name="FIELD_CHD_NUMBER"  class="simpleBox m_day"  id="FIELD_CHD_NUMBER">
                    ...
                    <input type="hidden" name="ALLOW_PRIMARY_CHD" id="ALLOW_PRIMARY_CHD" value="Y" /></td>
                </tr>
                <tr id="passengerINFANTSRow" _ispassengercontainer="true">
                  <td> 嬰兒</td>
                  <td id="INFANTSCell"><select name="FIELD_INFANTS_NUMBER"   class="simpleBox m_day"  id="FIELD_INFANTS_NUMBER">
                      <option value="0" selected="selected">0</option>
                      <option value="1">1</option>
                      <option value="2">2</option>
                      <option value="3">3</option>
            ...
            <td valign="bottom" id="fareTypeIdTD"><div style="margin-top:25px;">
              
              <!--<td valign="top" id="cabinTypeIdTD" >--> 
              <!-- VP page so only one fare Familiy -->
              
              <div id="SDComplexCabinDiv">
                <table cellpadding="0" cellspacing="0" id="tablePricingType" style="line-height:35px;">
                  <tr>
                    
                    <td class="textBold" style="vertical-align:middle;text-align:right;"> 價格類型:&nbsp;<select class="simpleBox s_year"  name="CABIN" id="cboCabinOption">
                        <option value="F">頭等艙</option>
                        <option value="B">商務舱</option>
                        <option value="E" selected="selected">經濟舱</option>
                      </select></td>
                      <td><span class="ImgError" id='WDSErrorImgtablePricingType' style="display: none">&nbsp;</span></td>
                  </tr>
                  <tr>
                    <td nowrap="nowrap" class="textBold" style="vertical-align:middle;text-align:right;"> 最高停靠次數:&nbsp; <select  class="simpleBox m_day"   name="AIR_MAX_CONNECTIONS" id="AIR_MAX_CONNECTIONS">
                        <option value="0">0</option>
                        <option value="1">1</option>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="height:115px; width:100%; "  >
                  <tr>
                  <td>
                  <table cellpadding="0" cellspacing="0" id="tableTheseAirlinesOnly" style="padding-top:15px;">
                  <tr>
                    <td class="textBold" colspan="2"><span class="ImgError" id='WDSErrorImgtableTheseAirlinesOnly' style="display: none"> &nbsp;</span>指定航空公司:&nbsp; </td>

                    <td nowrap="nowrap"><input name="AIRLINE_1" id="AIRLINE_1" type="text" size="14" maxlength="2" />
                      <span class="ImgLookUp" title="按一下此處可啟動偏好航空公司快顯視窗" onclick="javascript:etravel.openAirLine('AIRLINE_1');"> &nbsp;</span></td>
                  </tr>
                  <tr style="display:none;">
                    <td> 2 </td>
                    <td ><input name="AIRLINE_2" id="AIRLINE_2" type="text" size="14" maxlength="2" />
                      <span class="ImgLookUp" title="按一下此處可啟動偏好航空公司快顯視窗" onclick="javascript:etravel.openAirLine('AIRLINE_2');"> &nbsp;</span></td>
                  </tr>
                  <tr style="display:none;">
                    <td> 3 </td>
                    <td><input name="AIRLINE_3" id="AIRLINE_3" type="text" size="14" maxlength="2" />
                      <span class="ImgLookUp" title="按一下此處可啟動偏好航空公司快顯視窗" onclick="javascript:etravel.openAirLine('AIRLINE_3');"> &nbsp;</span></td>
                  </tr>
                </table>
                  </td>
                  </tr>
                  <tr>
                    <td style="text-align:center; vertical-align:bottom; padding-bottom:15px;" ><a href="javascript:ADVS.check();" onclick="return !ADVS.alreadySubmited;" id="btnSearchADVSNFS"><img border="0" src="images/btn_search_cnt.jpg" /></a></td>
                  </tr>
                </table>
              </div>
  ...
  <table width="100%" cellpadding="0" cellspacing="1" class="tableSearchNavHeader" style="display:none;">
    <tr>
      <td valign="middle" nowrap="nowrap"><span style="font-size:12px; color:red; "><a href="paytype_cnt.php" target="_parent" style="color:red;display:none;">United, Continental, All Nippon 及 Delta信用卡支付，需另加3%手續費。</a></span></td>
      <td align="right" style="padding-left:0px;"><div > <a href="javascript:ADVS.check();" onclick="return !ADVS.alreadySubmited;" id="btnSearchADVSNFS"><img border="0" src="images/btn_search_cnt.jpg" /></a><span id="btnEdgeSearchADVSNFS"></span></div></td>
    </tr>
  </table>
    </div>
