                        ...
                        <tr height="335px">
                            <td colspan="3" >
                            <iframe src="<?php echo 'calendar.php?lan=CN&from=BJS&to=NYC&stops=0&&staydays=7&month='.date('Ym');?>" id="iframepage_calendar" name="iframepage_calendar" frameBorder="0" scrolling="no" width="969px"  height="335px"></iframe> 
                            </td>
                        </tr>
