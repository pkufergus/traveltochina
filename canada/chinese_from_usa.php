...
function disalbeHongKong(formid,formid2)
{
	...
	if (result == "Vancouver" || result =="Toronto" )
	{
		...
		obj.options.add(new Option("广州","CAN"));
		obj.options.add(new Option("成都","CTU"));
		obj.options.add(new Option("福州","FOC"));
		obj.options.add(new Option("深圳","SZX"));
		obj.options.add(new Option("重庆","CKG"));
		obj.options.add(new Option("厦门","XMN"));
		obj.options.add(new Option("长沙","CSX"));
		obj.options.add(new Option("武汉","WUH"));
		obj.options.add(new Option("天津","TSN"));
		obj.options.add(new Option("南京","NKG"));
		obj.options.add(new Option("青岛","TAO"));
		obj.options.add(new Option("大连","DLC"));
		obj.options.add(new Option("温州","WNZ"));
		obj.options.add(new Option("沈阳","SHE"));
		obj.options.add(new Option("杭州","HGH"));
		obj.options.add(new Option("贵阳","KWE"));
		obj.options.add(new Option("郑州","CGO"));
		obj.options.add(new Option("哈尔滨","HRB"));
		obj.options.add(new Option("昆明","KMG"));
		obj.options.add(new Option("西安","XIY"));
		obj.options.add(new Option("南宁","NNG"));
		obj.options.add(new Option("济南","TNA"));
		obj.options.add(new Option("太原","TYN"));
		obj.options.add(new Option("南昌","KHN"));
		obj.options.add(new Option("海口","HAK"));
		obj.options.add(new Option("长春","CGQ"));
		obj.options.add(new Option("乌鲁木齐","URC"));
		obj.options.add(new Option("其它城市（英文填写）","Others")); 
	}
	else
	{
		document.getElementById(formid2.replace("From_","")).value="Beijing";
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table2_B_LOCATION_1" <?php if(!$setfrom) echo ''; else echo 'style="display: none"'; ?>>
                                      <td nowrap="nowrap"><select style="width: 190px;" name="From_B_LOCATION_1" id="From_B_LOCATION_1" onchange="selectChange('From_B_LOCATION_1','B_LOCATION_1');disalbeHongKong('From_B_LOCATION_1','From_E_LOCATION_1');">
                                          <option selected="selected" value="Vancouver">温哥华</option>
                                          <option value="Toronto">多伦多</option>
                                          <option value="Montreal">蒙特利尔</option>
                                          <option value="Calgary">卡尔加里</option>
                                          <option value="Edmonton">埃德蒙顿</option>
...
<option value="URC">乌鲁木齐</option>
          ...
          <tr>
            ...
            <td width="145px" valign="bottom"><div id="SDComplexAirlinesDiv">
                <table cellpadding="0" cellspacing="0" id="tableTheseAirlinesOnly">
                  <tr>
                    <td class="textBold" colspan="2"><span class="ImgError" id='WDSErrorImgtableTheseAirlinesOnly' style="display: none"> &nbsp;</span>仅这些航空公司 </td>
                  </tr>
                  <tr>
                    <td> 1 </td>
  ...
  <table width="100%" cellpadding="0" cellspacing="1" class="tableSearchNavHeader" style="display:none;">
    <tr>
      <td valign="middle" nowrap="nowrap"><span style="font-size:12px; color:red; display:none;"><a href="paytype.php" target="_parent" style="color:red;display:none;">United, Continental, All Nippon 及 Delta信用卡支付，需另加3%手续费。</a></span></td>
