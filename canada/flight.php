                        ...
                        <tr height="335px">
                            <td colspan="3" >
                            <iframe src="<?php echo '../calendar_6m_datamonotor_all.php?lan=CN&from=YVR&to=BJS&stops=0&staydays=14&title='.urlencode('温哥华至北京特价机票').'&month='.date('Ym')?>" id="iframepage_calendar" name="iframepage_calendar" frameBorder="0" scrolling="no" width="969px"  height="1070px"></iframe> 
                            </td>
                        </tr>
						...
						<table border="0" cellspacing="5" cellpadding="5" width="98%" align="center">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                    <a href="../cheap-flights-from-toronto-to-shanghai/" target="_parent" style="font-size:12px"> 多伦多至香港特价机票</a>  
                                    </td>
									<td>
                                    <a href="../cheap-flights-from-vancouver-to-hongkong/" target="_parent" style="font-size:12px"> 温哥华至北京特价机票</a> 
                                    </td>
									<td>
                                    <a href="../cheap-flights-from-vancouver-to-shanghai/" target="_parent" style="font-size:12px;"> 温哥华至上海特价机票</a> 
                                    </td>
                                    <td>
                                    <a href="../cheap-flights-from-vancouver-to-hongkong/" target="_parent" style="font-size:12px;"> 温哥华至香港特价机票</a> 
                                    </td>									
                                </tr>
                                <tr>
                                    <td>
                                     <a href="../cheap-flights-from-montreal-to-beijing/" target="_parent" style="font-size:12px"> 蒙特利尔至北京特价机票</a> 
                                    </td>
									<td>
                                    <a href="../cheap-flights-from-montreal-to-shanghai/" target="_parent" style="font-size:12px"> 蒙特利尔至上海特价机票</a>  
                                    </td>
                                    <td>
                                    <a href="../cheap-flights-from-calgary-to-shanghai/" target="_parent" style="font-size:12px"> 卡尔加里至北京特价机票</a>  
                                    </td>
									<td>
                                    <a href="../cheap-flights-from-calgary-to-hongkong/" target="_parent" style="font-size:12px"> 卡尔加里至上海特价机票</a> 
                                    </td>
									<td>
                                    <a href="../cheap-flights-from-edmonton-to-shanghai/" target="_parent" style="font-size:12px;"> 埃德蒙顿至北京特价机票</a> 
                                    </td>
                                    <td>
                                    <a href="../cheap-flights-from-edmonton-to-hongkong/" target="_parent" style="font-size:12px;"> 埃德蒙顿至上海特价机票</a> 
                                    </td>									
                                </tr>
                                <tr>
                                    <td>
                                     <a href="../cheap-flights-from-ottawa-to-beijing/" target="_parent" style="font-size:12px"> 渥太华至北京特价机票</a> 
                                    </td>
									<td>
                                    <a href="../cheap-flights-from-ottawa-to-shanghai/" target="_parent" style="font-size:12px"> 渥太华至上海特价机票</a>  
                                    </td>
                                    <td>
                                    <a href="../cheap-flights-from-winnipeg-to-shanghai/" target="_parent" style="font-size:12px"> 温尼伯至北京特价机票</a>  
                                    </td>
									<td>
                                    <a href="../cheap-flights-from-winnipeg-to-hongkong/" target="_parent" style="font-size:12px"> 温尼伯至上海特价机票</a> 
                                    </td>
									<td>
                                    </td>
                                    <td>
