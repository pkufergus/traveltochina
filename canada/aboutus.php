...
<a name=FLIGHT></a>
    <div id="maincontainer">
        <?php $aboutForm = 'ABOUT'; require("top.php");?>
        <div id="content_area">
        <table border="0" cellspacing="0" cellpadding="0" style="vertical-align: text-top; ">
        	<tr>
                ...
                <td  style="width:1000px;">
                    <table border="0" cellspacing="0" width="850px" cellpadding="0" style="vertical-align: text-top;">
                     <tr>
                                                    ...
                                                    <tr id="tr_right_Chinese">
                                                        <td colspan="2">
                                                            <p style="padding-bottom: 18px; margin-top: 0px; padding-left: 20px; width: 350px;
                                                                ...
                                                                <font color="#000000" size="4" face="微软雅黑"><strong>我们承诺</strong></font></p>
                                                    ...
                                                    <tr id="tr_right_Chinese">
                                                        <td colspan="2">
                                                            <p style="padding-bottom: 18px; margin-top: 0px; padding-left: 20px; width: 270px;
                                                                margin-bottom: 0px; padding-top: 8px">
                                                                <font color="#000000" size="4" face="微软雅黑"><strong>选择我们的理由</strong></font></p>
