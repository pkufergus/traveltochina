...
<title>E-TraveltoChina.com -搜尋</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="Description" content="搜尋航班排期表、搜尋航班時刻表、取得目前航班狀態、尋找旅館、尋找租車、取得行程工具、計劃行程。尋找機場資訊" />
<meta name="关键字" content="航班可售機位,航班,航班排期表,航班時間,低價航班,航班狀態,旅館搜尋,租車,商務旅遊,旅遊指南,世界時鐘,世界時間,E-travel" />
...
//-->
function disalbeHongKong(formid,formid2)
{
	var result = document.getElementById(formid).value ;
	var obj=document.getElementById(formid2);
	obj.options.length=0;
	if (result == "Vancouver" || result =="Toronto" )
	{
		document.getElementById(formid2.replace("From_","")).value="Beijing";
		obj.options.add(new Option("北京","Beijing")); 
		obj.options.add(new Option("上海","Shanghai")); 
		obj.options.add(new Option("香港","Hong Kong")); 
		obj.options.add(new Option("廣州","CAN"));
		obj.options.add(new Option("成都","CTU"));
		obj.options.add(new Option("福州","FOC"));
		obj.options.add(new Option("深圳","SZX"));
		obj.options.add(new Option("重慶","CKG"));
		obj.options.add(new Option("廈門","XMN"));
		obj.options.add(new Option("長沙","CSX"));
		obj.options.add(new Option("武漢","WUH"));
		obj.options.add(new Option("天津","TSN"));
		obj.options.add(new Option("南京","NKG"));
		obj.options.add(new Option("青島","TAO"));
		obj.options.add(new Option("大連","DLC"));
		obj.options.add(new Option("溫州","WNZ"));
		obj.options.add(new Option("瀋陽","SHE"));
		obj.options.add(new Option("杭州","HGH"));
		obj.options.add(new Option("貴陽","KWE"));
		obj.options.add(new Option("鄭州","CGO"));
		obj.options.add(new Option("哈爾濱","HRB"));
		obj.options.add(new Option("昆明","KMG"));
		obj.options.add(new Option("西安","XIY"));
		obj.options.add(new Option("南寧","NNG"));
		obj.options.add(new Option("濟南","TNA"));
		obj.options.add(new Option("太原","TYN"));
		obj.options.add(new Option("南昌","KHN"));
		obj.options.add(new Option("海口","HAK"));
		obj.options.add(new Option("長春","CGQ"));
		obj.options.add(new Option("烏魯木齊","URC"));
		obj.options.add(new Option("其它城市（英文填寫）","Others")); 
	}
	else
	{
		document.getElementById(formid2.replace("From_","")).value="Beijing";
...
<table class="layoutTable">
  ...
  <!--<form name="ADVSForm" id="ADVSForm" method="post" target="_parent" action="http://wftc1.e-travel.com/plnext/AIEADRHADRH/Override.action?EMBEDDED_TRANSACTION=TravelShopperAvailability&SITE=ADRHADRH&LANGUAGE=CN" class="transparentForm">-->
  <form name="ADVSForm" id="ADVSForm" target="_parent" method="post" action="http://wftc1.e-travel.com/plnext/AIEADRHADRH/AvailabilityFlowDispatcher.action?SITE=ADRHADRH&LANGUAGE=CN"
    ...
    <!--input type="hidden" name="SITE" value='ADRHADRH' />
                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table_B_LOCATION_1_Cpx" style="display: none">
                                      <td><span class="nowrap">
                                        <input name="B_LOCATION_1_Cpx" id="B_LOCATION_1_Cpx" value="Vancouver" type="text"
                                                                                                                size="30" />
                                    ...
                                    <tr id="Table2_B_LOCATION_1_Cpx">
                                      <td nowrap="nowrap"><select style="width: 190px;" name="From_B_LOCATION_1_Cpx" id="From_B_LOCATION_1_Cpx"
                                                                                                            onchange="selectChange('From_B_LOCATION_1_Cpx','B_LOCATION_1_Cpx');disalbeHongKong('From_B_LOCATION_1_Cpx','From_E_LOCATION_1_Cpx');">
                                          <option selected value="Vancouver">溫哥華</option>
                                          <option value="Toronto">多倫多</option>
										  <option value="Montreal">蒙特利爾</option>
                                          <option value="Calgary">卡爾加里</option>
                                          <option value="Edmonton">埃德蒙頓</option>
                                          <option value="Ottawa">渥太華</option>
                                          <option value="Winnipeg">溫尼伯</option>
                                ...
                                <td style="padding: 0px;"><input id="backE_LOCATION_1_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table2_E_LOCATION_1_Cpx">
                                      <td id="departureLocationCell_1" nowrap="nowrap"><select style="width: 190px;" name="From_E_LOCATION_1_Cpx" id="From_E_LOCATION_1_Cpx"
                                                                                                            onchange="selectChange('From_E_LOCATION_1_Cpx','E_LOCATION_1_Cpx');">
                                          <option selected value="BJS">北京</option>
<option value="SHA">上海</option>

<option value="CAN">廣州</option>
                                ...
                                <td style="padding: 0px;"><input id="backB_LOCATION_2_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table2_B_LOCATION_2_Cpx">
                                      <td nowrap="nowrap"><select style="width: 190px;" name="From_B_LOCATION_2_Cpx" id="From_B_LOCATION_2_Cpx"
                                                                                                            onchange="selectChange('From_B_LOCATION_2_Cpx','B_LOCATION_2_Cpx');disalbeHongKong('From_B_LOCATION_2_Cpx','From_E_LOCATION_2_Cpx');">
                                          <option value=""></option>
                                ...
                                <td style="padding: 0px;"><input id="backE_LOCATION_2_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table2_E_LOCATION_2_Cpx">
                                      <td nowrap="nowrap"><select style="width: 190px;" name="From_E_LOCATION_2_Cpx" id="From_E_LOCATION_2_Cpx"
                                ...
                                <td style="padding: 0px;"><input id="backB_LOCATION_3_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table2_B_LOCATION_3_Cpx">
                                      <td nowrap="nowrap"><select style="width: 190px;" name="From_B_LOCATION_3_Cpx" id="From_B_LOCATION_3_Cpx"
                                                                                                            onchange="selectChange('From_B_LOCATION_3_Cpx','B_LOCATION_3_Cpx');disalbeHongKong('From_B_LOCATION_3_Cpx','From_E_LOCATION_3_Cpx');">
                                          <option value=""></option>
                                           <option value="Vancouver">溫哥華</option>
                                          <option value="Toronto">多倫多</option>
										  <option value="Montreal">蒙特利爾</option>
                                ...
                                <td style="padding: 0px;"><input id="backE_LOCATION_3_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table2_E_LOCATION_3_Cpx">
                                      <td nowrap="nowrap"><select style="width: 190px;" name="From_E_LOCATION_3_Cpx" id="From_E_LOCATION_3_Cpx"
                                ...
                                <td style="padding: 0px;"><input id="backB_LOCATION_4_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table2_B_LOCATION_4_Cpx">
                                      <td nowrap="nowrap"><select style="width: 190px;" name="From_B_LOCATION_4_Cpx" id="From_B_LOCATION_4_Cpx"
                                                                                                            onchange="selectChange('From_B_LOCATION_4_Cpx','B_LOCATION_4_Cpx');disalbeHongKong('From_B_LOCATION_4_Cpx','From_E_LOCATION_4_Cpx');">
                                          <option value=""></option>
                                           <option value="Vancouver">溫哥華</option>
                                          <option value="Toronto">多倫多</option>
										  <option value="Montreal">蒙特利爾</option>
                                ...
                                <td style="padding: 0px;"><input id="backE_LOCATION_4_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table2_E_LOCATION_4_Cpx">
                                      <td nowrap="nowrap"><select style="width: 190px;" name="From_E_LOCATION_4_Cpx" id="From_E_LOCATION_4_Cpx"
                                ...
                                <td style="padding: 0px;"><input id="backB_LOCATION_5_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table2_B_LOCATION_5_Cpx">
                                      <td nowrap="nowrap"><select style="width: 190px;" name="From_B_LOCATION_5_Cpx" id="From_B_LOCATION_5_Cpx"
                                                                                                            onchange="selectChange('From_B_LOCATION_5_Cpx','B_LOCATION_5_Cpx');disalbeHongKong('From_B_LOCATION_5_Cpx','From_E_LOCATION_5_Cpx');">
                                          <option value=""></option>
                                           <option value="Vancouver">溫哥華</option>
                                          <option value="Toronto">多倫多</option>
										  <option value="Montreal">蒙特利爾</option>
                                ...
                                <td style="padding: 0px;"><input id="backE_LOCATION_5_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table2_E_LOCATION_5_Cpx">
                                      <td nowrap="nowrap"><select style="width: 190px;" name="From_E_LOCATION_5_Cpx" id="From_E_LOCATION_5_Cpx"
                                ...
                                <td style="padding: 0px;"><input id="backB_LOCATION_6_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table2_B_LOCATION_6_Cpx">
                                      <td nowrap="nowrap"><select style="width: 190px;" name="From_B_LOCATION_6_Cpx" id="From_B_LOCATION_6_Cpx"
                                                                                                            onchange="selectChange('From_B_LOCATION_6_Cpx','B_LOCATION_6_Cpx');disalbeHongKong('From_B_LOCATION_6_Cpx','From_E_LOCATION_6_Cpx');">
                                          <option value=""></option>
                                           <option value="Vancouver">溫哥華</option>
                                          <option value="Toronto">多倫多</option>
										  <option value="Montreal">蒙特利爾</option>
                                ...
                                <td style="padding: 0px;"><input id="backE_LOCATION_6_Cpx" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table2_E_LOCATION_6_Cpx">
                                      <td nowrap="nowrap"><select style="width: 190px;" name="From_E_LOCATION_6_Cpx" id="From_E_LOCATION_6_Cpx"
                                ...
                                <td style="padding: 0px;"><input id="backB_LOCATION_1" type="hidden" />
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table2_B_LOCATION_1" <?php if(!$setfrom) echo ''; else echo 'style="display: none"'; ?>>
                                      <td nowrap="nowrap"><select style="width: 190px;" name="From_B_LOCATION_1" id="From_B_LOCATION_1" onchange="selectChange('From_B_LOCATION_1','B_LOCATION_1');disalbeHongKong('From_B_LOCATION_1','From_E_LOCATION_1');">
                                           <option selected="selected" value="Vancouver">溫哥華</option>
                                          <option value="Toronto">多倫多</option>
										  <option value="Montreal">蒙特利爾</option>
                                          <option value="Calgary">卡爾加里</option>
                                          <option value="Edmonton">埃德蒙頓</option>
                              ...
                              <td style="padding: 0px;"><input id="backE_LOCATION_1" type="hidden" />
                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                  ...
                                  <tr id="Table2_E_LOCATION_1" <?php if(!$setto) echo ''; else echo 'style="display: none"'; ?>>
                                    <td nowrap="nowrap"><select style="width: 190px;" name="From_E_LOCATION_1" id="From_E_LOCATION_1" onchange="selectChange('From_E_LOCATION_1','E_LOCATION_1')">
...
<option value="URC">烏魯木齊</option>
        ...
        <table cellpadding="0" cellspacing="0" width="410px" >
          ...
          <tr>
            <td width="170" valign="bottom"><table cellpadding="0" cellspacing="0" id="tableTravellers">
                <tr>
                ...
                <tr id="passengerADTRow" _ispassengercontainer="true">
                  <td> 成人(十二歲及以上) </td>
                  <td id="ADTCell"><select name="FIELD_ADT_NUMBER" id="FIELD_ADT_NUMBER">
                ...
                <tr id="passengerCHDRow" _ispassengercontainer="true">
                  <td> 兒童(兩歲至十一歲) </td>
                  <td id="CHDCell"><select name="FIELD_CHD_NUMBER" id="FIELD_CHD_NUMBER">
                ...
                <tr id="passengerINFANTSRow" _ispassengercontainer="true">
                  <td> 嬰兒(兩歲以下) </td>
                  <td id="INFANTSCell"><select name="FIELD_INFANTS_NUMBER" id="FIELD_INFANTS_NUMBER">
                      <option value="0" selected="selected">0</option>
                      <option value="1">1</option>
                      <option value="2">2</option>
                      <option value="3">3</option>
            ...
            <td valign="bottom" id="fareTypeIdTD"><div>
              ...
              <div id="SDComplexCabinDiv">
                <table cellpadding="0" cellspacing="0" id="tablePricingType">
                  <tr>
                    ...
                    <td class="textBold"> 價格類型 </td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td><select name="CABIN" id="cboCabinOption">
              ...
              <div id="divMaxNumberOfStop">
                <table cellpadding="0" cellspacing="0" id="tableMaxNumberOfStop">
                  <tr>
                    <td>&nbsp;</td>
                    <td class="textBold"> 最高停靠次數 </td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td><select name="AIR_MAX_CONNECTIONS" id="AIR_MAX_CONNECTIONS">
                        <option value="0">0</option>
                        <option value="1">1</option>
            ...
            <td width="145px" valign="bottom"><div id="SDComplexAirlinesDiv">
                <table cellpadding="0" cellspacing="0" id="tableTheseAirlinesOnly">
                  <tr>
                    <td class="textBold" colspan="2"><span class="ImgError" id='WDSErrorImgtableTheseAirlinesOnly' style="display: none"> &nbsp;</span>僅這些航空公司 </td>
                  </tr>
                  <tr>
                    <td> 1 </td>
                    <td><input name="AIRLINE_1" id="AIRLINE_1" type="text" size="14" maxlength="2" />
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="height:115px; width:100%; "  >
                  <tr>
                    <td style="text-align:right; vertical-align:bottom;" ><a href="javascript:ADVS.check();" onclick="return !ADVS.alreadySubmited;" id="btnSearchADVSNFS"><img border="0" src="images/btn_search_cnt.jpg" /></a></td>
                  </tr>
                </table>
              </div>
  ...
  <table width="100%" cellpadding="0" cellspacing="1" class="tableSearchNavHeader" style="display:none;">
    <tr>
      <td valign="middle" nowrap="nowrap"><span style="font-size:12px; color:red; display:none;"><a href="paytype_cnt.php" target="_parent" style="color:red;display:none;">United, Continental, All Nippon 及 Delta信用卡支付，需另加3%手續費。</a></span></td>
