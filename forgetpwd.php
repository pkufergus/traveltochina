                            ...
                            <td valign="top" colspan="2" >
                                <table cellspacing="0" cellpadding="0" style="width: 100%; height: 10px;">
									...
									<div style='font-family: "微软雅黑"; font-size :12px;text-align: center;'>
										...
										<p style='position: absolute; margin-left: 351px;'> 邮箱&nbsp;&nbsp;&nbsp;&nbsp;
										<input style='height:30px' class='login-txt' type="text" name="email" id="emailTxt" ><span class="warn-msg" id="emailTxt-span"></span>
										</p>
										<p  style=' position: absolute;  margin-left: 339px; margin-top: 59px;'>
										用户名&nbsp;&nbsp;&nbsp;&nbsp;
										<input class='login-txt' style='height:30px'  type="text" name="usernametxt" id="usernameTxt"><span class="warn-msg" id="usernameTxt-span"></span>
										</p>
										<p style='margin-left: -8px;'>
										<input type="text" style=' width: 120px; margin-left:51px;margin-top:105px;position: absolute; height: 30px;border-radius:3px;border: solid 1px rgb(194, 184, 184);' placeholder="请输入验证码" id="checkCodeTxt"/>
										...
										<input class='login-btn-login' style='height:35px;  margin-left: 16px;' type="button" id="find_pwd_btn" value="找回密码">
