                                  ...
                                  <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    ...
                                    <tr id="Table2_B_LOCATION_1_Cpx">
                                      <td nowrap="nowrap"><select style="width: 190px;" name="From_B_LOCATION_1_Cpx" id="From_B_LOCATION_1_Cpx"
                                         ...
                                         <option  selected="selected"  value="Los Angeles">洛杉磯</option>
                                          <option value="New York">紐約</option>
                                          <option value="San Francisco">三藩市</option>
										  <option value="Boston">波士頓</option>
										  <option value="Chicago">芝加哥</option>
										  <option value="Houston">休士頓</option>
										  <option value="Washington">華盛頓</option>
