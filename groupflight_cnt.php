...
<body><a name=FLIGHT></a>
    <div id="maincontainer">
        <?php $aboutForm = 'GROUP';  require("top_cnt.php");?>
        <div id="content_area">
                          ...
                          <table  cellspacing="0" cellpadding="0" style="width: 100%; height: 300px;">
                            <tr>
                                ...
                                <script type="text/javascript" language="javascript">  
                                                    ...
                                                    <iframe src="groupquery_cnt.php" id="iframe_group" name="iframe_group" frameBorder="0" scrolling="no" width="960px"  onLoad="IFrameReSize_group('iframe_group');" ></iframe>                    
