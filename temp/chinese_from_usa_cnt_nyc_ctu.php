        ...
        <div id="WDSWaitingImageDivID" style="display: none; align: center;">
            <div id="divWait">
                ...
                <p id="title">
                    我們正在處理您的要求，請稍候...</p>
                <p id="indicator">
                    <img id="WDSProgressImageImgID" alt='我們正在處理您的要求，請稍候...' /></p>
                <p id="info">
                </p>
            </div>
        </div>
...
<input type="hidden" name="LANGUAGE" value='CN' /> -->
                            ...
                            <td>
                                <table cellspacing="0" cellpadding="0" class="tableSearchMain">
                                            ...
                                            <div id="complexDataId" style="visibility: hidden; display: none; height: 1px;">
                                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tr style="display:none;">
                                                        <td>
                                                            <span class="textSmaller">* 如果不確定某個城市或機場的拼寫，請輸入前 3 個或更多字母並加上一個星號 (*)。&nbsp;</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="padding: 0px;">
                                                                                                        <span class="ImgError" id="WDSErrorImgTRB_LOCATION_1_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">始發</span>城市或機場*
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr id="Table_B_LOCATION_1_Cpx" style="display: none">
                                                                                                    <td>
                                                                                                        <span class="nowrap">
                                                                                                            <input name="B_LOCATION_1_Cpx" id="B_LOCATION_1_Cpx" value="NYC" type="text"
                                                                                                                size="30" />
                                                                                                            <span class="ImgLookUp" title="按一下此處可啟動偏好航空公司快顯視窗" onclick="javascript:etravel.openLocation('B_LOCATION_1_Cpx');">
                                                                                                                &nbsp;</span> </span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr id="Table2_B_LOCATION_1_Cpx">
                                                                                                    <td nowrap="nowrap">
                                                                                                        <select style="width: 190px;" name="From_B_LOCATION_1_Cpx" id="From_B_LOCATION_1_Cpx"
                                                                                                          ...
                                                                                                          <option selected="selected" value="New York">紐約</option>
                                                                                                          ...
                                                                                                          <option value="Seattle">西雅圖</option><option style="font-weight: bold" value="Others">OTHERS CITIES(英文填寫任何其它城市或機場）</option>
                                                                                                        </select>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="padding: 0px;">
                                                                                                        <span class="ImgError" id="WDSErrorImgTRE_LOCATION_1_Cpx" style="display: none">&nbsp;</span><span
                                                                                                            class="textBold">目的</span>城市或機場*
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr id="Table_E_LOCATION_1_Cpx" style="display: none">
                                                                                                    <td>
                                                                                                        <span class="nowrap">
                                                                                                            <input name="E_LOCATION_1_Cpx" id="E_LOCATION_1_Cpx" value="CTU" type="text"
                                                                                                                size="30" />
                                                                                                        </span><span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('E_LOCATION_1_Cpx');">
                                                                                                            &nbsp;</span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr id="Table2_E_LOCATION_1_Cpx">
                                                                                                    <td id="departureLocationCell_1" nowrap="nowrap">
                                                                                                        <select style="width: 190px;" name="From_E_LOCATION_1_Cpx" id="From_E_LOCATION_1_Cpx"
                                                                                                          ...
                                                                                                          <option selected value="CTU">成都</option> 
                                                                                                          ...
                                                                                                          <option value="URC">烏魯木齊</option>                                                                                                           
                                                                                                            <option style="font-weight: bold" value="Others">OTHERS CITIES(英文填寫任何其它城市或機場）</option>
                                                                                                        </select>
                                                                                                    </td>
                                                                                                </tr>
                                                                                ...
                                                                                <div class="searchDateSelectionPanel" id="divB_DATE1Cpx">
                                                                                    <ul class="selector date">
                                                                                        ...
                                                                                        <li class="value" id="DateCmp1Cpx">
                                                                                            <label for="Month1Cpx">
                                                                                                <span class="ImgError" id="WDSErrorImgB_DATE1Cpx" style="display: none">&nbsp;</span>啟程日期</label>
                                                                                            ...
                                                                                            <span id="linkCalendar1Cpx" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                                                                ...
                                                                                                <tr id="Table_B_LOCATION_2_Cpx" style="display: none">
                                                                                                    <td>
                                                                                                        <span class="nowrap">
                                                                                                            ...
                                                                                                            <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('B_LOCATION_2_Cpx');">
                                                                                                                &nbsp;</span> </span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr id="Table_E_LOCATION_2_Cpx" style="display: none">
                                                                                                    <td>
                                                                                                        <span class="nowrap">
                                                                                                            ...
                                                                                                            <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('E_LOCATION_2_Cpx');">
                                                                                                                &nbsp;</span> </span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr id="Table2_E_LOCATION_2_Cpx">
                                                                                                    <td nowrap="nowrap">
                                                                                                        <select style="width: 190px;" name="From_E_LOCATION_2_Cpx" id="From_E_LOCATION_2_Cpx"
                                                                                                          ...
                                                                                                          <option value="HAK">海口</option> 
                                                                                                          <option value="CGQ">長春</option> 
                                                                                                          <option value="URC">烏魯木齊</option><option style="font-weight: bold" value="Others">OTHERS CITIES(英文填寫任何其它城市或機場）</option>
                                                                                                        </select>
                                                                                                    </td>
                                                                                                </tr>
                                                                                ...
                                                                                <div class="searchDateSelectionPanel" id="divB_DATE2Cpx">
                                                                                    <ul class="selector date">
                                                                                        ...
                                                                                        <li class="value" id="DateCmp2Cpx">
                                                                                            <label for="Month2Cpx">
                                                                                                <span class="ImgError" id="WDSErrorImgB_DATE2Cpx" style="display: none">&nbsp;</span>啟程日期</label>
                                                                                            ...
                                                                                            <span id="linkCalendar2Cpx" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                                                                ...
                                                                                                <tr id="Table_B_LOCATION_3_Cpx" style="display: none">
                                                                                                    <td>
                                                                                                        <span class="nowrap">
                                                                                                            ...
                                                                                                            <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('B_LOCATION_3_Cpx');">
                                                                                                                &nbsp;</span> </span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr id="Table_E_LOCATION_3_Cpx" style="display: none">
                                                                                                    <td>
                                                                                                        <span class="nowrap">
                                                                                                            ...
                                                                                                            <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('E_LOCATION_3_Cpx');">
                                                                                                                &nbsp;</span> </span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr id="Table2_E_LOCATION_3_Cpx">
                                                                                                    <td nowrap="nowrap">
                                                                                                        <select style="width: 190px;" name="From_E_LOCATION_3_Cpx" id="From_E_LOCATION_3_Cpx"
                                                                                                            ...
                                                                                                            <option selected value=""></option><option value="BJS">北京</option> 
                                                                                                          <option value="SHA">上海</option> 
                                                                                                          <option value="HKG">香港</option> 
                                                                                                          <option value="CAN">廣州</option>
                                                                                                          <option value="CTU">成都</option> 
                                                                                ...
                                                                                <div class="searchDateSelectionPanel" id="divB_DATE3Cpx">
                                                                                    <ul class="selector date">
                                                                                        ...
                                                                                        <li class="value" id="DateCmp3Cpx">
                                                                                            <label for="Month3Cpx">
                                                                                                <span class="ImgError" id="WDSErrorImgB_DATE3Cpx" style="display: none">&nbsp;</span>啟程日期</label>
                                                                                            ...
                                                                                            <span id="linkCalendar3Cpx" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                                                                ...
                                                                                                <tr id="Table_B_LOCATION_4_Cpx" style="display: none">
                                                                                                    <td>
                                                                                                        <span class="nowrap">
                                                                                                            ...
                                                                                                            <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('B_LOCATION_4_Cpx');">
                                                                                                                &nbsp;</span> </span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr id="Table_E_LOCATION_4_Cpx" style="display: none">
                                                                                                    <td>
                                                                                                        <span class="nowrap">
                                                                                                            ...
                                                                                                            <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('E_LOCATION_4_Cpx');">
                                                                                                                &nbsp;</span> </span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                ...
                                                                                <div class="searchDateSelectionPanel" id="divB_DATE4Cpx">
                                                                                    <ul class="selector date">
                                                                                        ...
                                                                                        <li class="value" id="DateCmp4Cpx">
                                                                                            <label for="Month4Cpx">
                                                                                                <span class="ImgError" id="WDSErrorImgB_DATE4Cpx" style="display: none">&nbsp;</span>啟程日期</label>
                                                                                            ...
                                                                                            <span id="linkCalendar4Cpx" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                                                                ...
                                                                                                <tr id="Table_B_LOCATION_5_Cpx" style="display: none">
                                                                                                    <td>
                                                                                                        <span class="nowrap">
                                                                                                            ...
                                                                                                            <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('B_LOCATION_5_Cpx');">
                                                                                                                &nbsp;</span> </span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr id="Table_E_LOCATION_5_Cpx" style="display: none">
                                                                                                    <td>
                                                                                                        <span class="nowrap">
                                                                                                            ...
                                                                                                            <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('E_LOCATION_5_Cpx');">
                                                                                                                &nbsp;</span> </span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                ...
                                                                                <div class="searchDateSelectionPanel" id="divB_DATE5Cpx">
                                                                                    <ul class="selector date">
                                                                                        ...
                                                                                        <li class="value" id="DateCmp5Cpx">
                                                                                            <label for="Month5Cpx">
                                                                                                <span class="ImgError" id="WDSErrorImgB_DATE5Cpx" style="display: none">&nbsp;</span>啟程日期</label>
                                                                                            ...
                                                                                            <span id="linkCalendar5Cpx" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                                                                ...
                                                                                                <tr id="Table_B_LOCATION_6_Cpx" style="display: none">
                                                                                                    <td>
                                                                                                        <span class="nowrap">
                                                                                                            ...
                                                                                                            <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('B_LOCATION_6_Cpx');">
                                                                                                                &nbsp;</span> </span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr id="Table2_B_LOCATION_6_Cpx">
                                                                                                    <td nowrap="nowrap">
                                                                                                        <select style="width: 190px;" name="From_B_LOCATION_6_Cpx" id="From_B_LOCATION_6_Cpx"
                                                                                                            ...
                                                                                                            <option selected value=""></option>																											<option value="Los Angeles">洛杉磯</option>
                                                                                                          <option value="New York">紐約</option>
                                                                                                          <option value="San Francisco">三藩市</option>
                                                                                                          <option value="Boston">波士頓</option>
                                                                                                          <option value="Chicago">芝加哥</option>
                                                                                                ...
                                                                                                <tr id="Table_E_LOCATION_6_Cpx" style="display: none">
                                                                                                    <td>
                                                                                                        <span class="nowrap">
                                                                                                            ...
                                                                                                            <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('E_LOCATION_6_Cpx');">
                                                                                                                &nbsp;</span> </span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                ...
                                                                                <div class="searchDateSelectionPanel" id="divB_DATE6Cpx">
                                                                                    <ul class="selector date">
                                                                                        ...
                                                                                        <li class="value" id="DateCmp6Cpx">
                                                                                            <label for="Month6Cpx">
                                                                                                <span class="ImgError" id="WDSErrorImgB_DATE6Cpx" style="display: none">&nbsp;</span>啟程日期</label>
                                                                                            ...
                                                                                            <span id="linkCalendar6Cpx" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                                                                    ...
                                                                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                                                        ...
                                                                                                        <tr id="Table_B_LOCATION_1" <?php if($setfrom) echo ''; else echo 'style="display: none"'; ?> >
                                                                                                            <td nowrap="nowrap">
                                                                                                                ...
                                                                                                                <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('B_LOCATION_1');">
                                                                                                                    &nbsp;</span>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    ...
                                                                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                                                        ...
                                                                                                        <tr id="Table_E_LOCATION_1" <?php if($setto) echo ''; else echo 'style="display: none"'; ?>>
                                                                                                            <td id="arrivalLocationCell_1" nowrap="nowrap">
                                                                                                                ...
                                                                                                                <span class="ImgLookUp" title="按一下此處可啟動城市彈出視窗" onclick="javascript:etravel.openLocation('E_LOCATION_1');">
                                                                                                                    &nbsp;</span>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                            </tr>
                                    ...
                                    <tr style="display:none;">
                                        ...
                                        <td >
                                            <span class="spellingLabel">* 如果不確定某個城市或機場的拼寫，請輸入前 3 個或更多字母並加上一個星號 (*)。 </span>
                                        </td>
                                        <td>&nbsp;
                                            ...
                                            <div class="searchDateSelectionPanel" id="divB_DATE1">
                                                <ul class="selector date">
                                                    ...
                                                    <li class="value" id="DateCmp1">
                                                        <label for="Month1">
                                                            <span class="ImgError" id="WDSErrorImgB_DATE1" style="display: none">&nbsp;</span>啟程日期</label>
                                                        ...
                                                        <span id="linkCalendar1" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                ...
                                                <div class="searchDateSelectionPanel" id="divE_DATE2">
                                                    <ul class="selector date">
                                                        ...
                                                        <li class="value" id="DateCmp2">
                                                            ...
                                                            <span id="linkCalendar2" title="按一下此處可搜尋日期" class="ImgCal">&nbsp;&nbsp;&nbsp;&nbsp;</span>
            ...
            <div id="SDComplexAirlinesDiv">
                <table cellpadding="0" cellspacing="0" id="tableTheseAirlinesOnly">
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="AIRLINE_1" id="AIRLINE_1" type="text" size="14" maxlength="2" />
                            <span class="ImgLookUp" title="按一下此處可啟動偏好航空公司快顯視窗" onclick="javascript:etravel.openAirLine('AIRLINE_1');">
                                &nbsp;</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="ImgLookUp" title="按一下此處可啟動偏好航空公司快顯視窗" onclick="javascript:etravel.openAirLine('AIRLINE_2');">
                                &nbsp;</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="ImgLookUp" title="按一下此處可啟動偏好航空公司快顯視窗" onclick="javascript:etravel.openAirLine('AIRLINE_3');">
                                &nbsp;</span>
                        </td>
                    </tr>
                </table>
    ...
    <table width="100%" cellpadding="0" cellspacing="1" class="tableSearchNavHeader" style="display:none;">
        ...
        <span style="font-size:12px; color:red; "><a href="paytype_cnt.php" target="_parent" style="color:red;display:none;">United, Continental, All Nippon 及 Delta信用卡支付，需另加3%手續費。</a></span>
        </td>
            <td align="right" style="padding-left:0px;">
                <div >
                    <a href="javascript:ADVS.check();" onclick="return !ADVS.alreadySubmited;" id="btnSearchADVSNFS"><img border="0" src="images/btn_search_cnt.jpg" /></a><span id="btnEdgeSearchADVSNFS"></span></div>
            </td>
        </tr>
    </table>
    </div>
