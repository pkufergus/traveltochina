                                                                                                    ...
                                                                                                    <td nowrap="nowrap">
                                                                                                        <select style="width: 190px;" name="From_B_LOCATION_1_Cpx" id="From_B_LOCATION_1_Cpx"
                                                                                                            ...
                                                                                                            <option value="Los Angeles">洛杉矶</option>
                                                                                                              <option selected="selected" value="New York">纽约</option>
                                                                                                ...
                                                                                                <tr id="Table2_E_LOCATION_1_Cpx">
                                                                                                    <td id="departureLocationCell_1" nowrap="nowrap">
                                                                                                        <select style="width: 190px;" name="From_E_LOCATION_1_Cpx" id="From_E_LOCATION_1_Cpx"
                                                                                                          ...
                                                                                                          <option selected  value="CAN">广州</option> 
                                                                                                          ...
                                                                                                          <option value="URC">乌鲁木齐</option><option style="font-weight: bold" value="Others">OTHERS CITIES(英文填写任何其它城市或机场）</option>
                                                                                                        </select>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr id="Table2_B_LOCATION_2_Cpx">
                                                                                                    <td nowrap="nowrap">
                                                                                                        <select style="width: 190px;" name="From_B_LOCATION_2_Cpx" id="From_B_LOCATION_2_Cpx"
                                                                                                            ...
                                                                                                            <option value="Los Angeles">洛杉矶</option>																										<option value="Los Angeles">洛杉矶</option>
                                                                                                              ...
                                                                                                              <option value="Houston">休斯敦</option>
                                                                                                              <option value="Washington">华盛顿</option>
                                                                                                              <option value="Seattle">西雅图</option><option style="font-weight: bold" value="Others">OTHERS CITIES(英文填写任何其它城市或机场）</option>
                                                                                                        </select>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr id="Table2_E_LOCATION_2_Cpx">
                                                                                                    <td nowrap="nowrap">
                                                                                                        <select style="width: 190px;" name="From_E_LOCATION_2_Cpx" id="From_E_LOCATION_2_Cpx"
                                                                                                            ...
                                                                                                            <option value=""></option><option value="BJS">北京</option> 
                                                                                                          <option value="SHA">上海</option> 
                                                                                                          <option value="HKG">香港</option> 
                                                                                                ...
                                                                                                <tr id="Table2_B_LOCATION_3_Cpx">
                                                                                                    <td nowrap="nowrap">
                                                                                                        <select style="width: 190px;" name="From_B_LOCATION_3_Cpx" id="From_B_LOCATION_3_Cpx"
                                                                                                            ...
                                                                                                            <option value=""></option><option value="Los Angeles">洛杉矶</option><option value="New York">纽约</option>
                                                                                                              <option value="San Francisco">旧金山</option>
                                                                                                              <option value="Boston">波士顿</option>
                                                                                                              <option value="Chicago">芝加哥</option>
                                                                                                              <option value="Houston">休斯敦</option>
                                                                                                ...
                                                                                                <tr id="Table2_B_LOCATION_4_Cpx">
                                                                                                    <td nowrap="nowrap">
                                                                                                        <select style="width: 190px;" name="From_B_LOCATION_4_Cpx" id="From_B_LOCATION_4_Cpx"
                                                                                                            ...
                                                                                                            <option selected value=""></option><option value="Los Angeles">洛杉矶</option>																											
                                                                                                            <option value="New York">纽约</option>
                                                                                                              <option value="San Francisco">旧金山</option>
                                                                                                              <option value="Boston">波士顿</option>
                                                                                                              <option value="Chicago">芝加哥</option>
                                                                                                        ...
                                                                                                        <tr id="Table2_B_LOCATION_1" <?php if(!$setfrom) echo ''; else echo 'style="display: none"'; ?>>
                                                                                                            <td nowrap="nowrap">
                                                                                                                <select style="width: 190px;" name="From_B_LOCATION_1" id="From_B_LOCATION_1" onchange="selectChange('From_B_LOCATION_1','B_LOCATION_1')">
                                                                                                                   	<option value="Los Angeles">洛杉矶</option><option selected="selected" value="New York">纽约</option>
                                                                                                              <option value="San Francisco">旧金山</option>
                                                                                                              <option value="Boston">波士顿</option>
                                                                                                              <option value="Chicago">芝加哥</option>
                                                                                                              <option value="Houston">休斯敦</option>
