                                                                                                ...
                                                                                                <tr id="Table2_B_LOCATION_3_Cpx">
                                                                                                    <td nowrap="nowrap">
                                                                                                        <select style="width: 190px;" name="From_B_LOCATION_3_Cpx" id="From_B_LOCATION_3_Cpx"
                                                                                                            ...
                                                                                                            <option value=""></option><option value="Los Angeles">洛杉矶</option><option value="New York">纽约</option><option value="San Francisco">旧金山</option>
                                                                                                              <option value="Boston">波士顿</option>
                                                                                                              <option value="Chicago">芝加哥</option>
                                                                                                              <option value="Houston">休斯敦</option>
                                                                                                              <option value="Washington">华盛顿</option>
                                                                                                ...
                                                                                                <tr id="Table2_B_LOCATION_4_Cpx">
                                                                                                    <td nowrap="nowrap">
                                                                                                        <select style="width: 190px;" name="From_B_LOCATION_4_Cpx" id="From_B_LOCATION_4_Cpx"
                                                                                                            ...
                                                                                                            <option selected value=""></option><option value="Los Angeles">洛杉矶</option><option value="New York">纽约</option>
                                                                                                              <option value="San Francisco">旧金山</option>
                                                                                                              <option value="Boston">波士顿</option>
                                                                                                              <option value="Chicago">芝加哥</option>
                                                                                                              <option value="Houston">休斯敦</option>
