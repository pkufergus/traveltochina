...
<head>
    ...
    <title>美中机票网：北美华人购买机票首选网站</title>
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="vertical-align: text-top; ">
        	<tr>
                ...
                <td  style="width:1000px;" valign="top">
                    <table border="0" cellspacing="0" cellpadding="0" style="vertical-align: text-top; width:1000px; ">
                    <tr id="content_top">
                        	<td>
                            </td>
                        </tr>
                        <tr id="content_middle">
                            <td valign="top" colspan="2" >
                               <iframe src="http://www.e-traveltochina.com:8008/register.aspx" id="iframepage" name="iframepage" frameBorder="0" scrolling="no" width="960px" height="2050px"   ></iframe> 
                            </td>
                        </tr>
