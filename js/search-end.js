...
function doubleSearch() { 
	...
	if(countryEnd == 'CA'){
		baseUrl = "http://www-amer.epower.amadeus.com/TraveltoChinaCorp/";
	}
...
//	fromDate = fromDateArry[1] + "/" + fromDateArry[2] + "/" + fromDateArry[0];
...
//	toDate = toDateArry[1] + "/" + toDateArry[2] + "/" + toDateArry[0];
	...
	+"&DepartureFlexibleDate="+$("#d-to-flex").val()+"&CabinClass="
	+$("#d-cabin-class").val()+"&DirectFlightsOnly="+$('#d-flight-chk').is(':checked');
...
//	fromDate = fromDateArry[1] + "/" + fromDateArry[2] + "/" + fromDateArry[0];
	...
	+"&CabinClass="
	+$("#s-cabin-class").val()+"&DirectFlightsOnly="+$('#s-flight-chk').is(':checked');
...
//	
	...
	lotUrl += "&CabinClass="
	+$("#lot-cabin-class").val()+"&DirectFlightsOnly="
	+$('#lot-flight-chk').is(':checked');
