	...
	ETravel.prototype = 
	{
		...
		keepCalendarGap: function(fromCal, days)
		{
			...
			if((fromCal == "#divB_DATE1"  || fromCal ==  "#divE_DATE2") && SelectTab=="R" )
			{
				...
				parent.document.getElementById("pricechart_month").src = "pricechart_city.php?type=MONTH&from="+from+"&to="+to+"&fromdate="+fromdate+"&todate="+todate;
				parent.document.getElementById("pricechart_year").src = "pricechart_city.php?type=YEAR&from="+from+"&to="+to+"&fromdate="+fromdate+"&todate="+todate;
