...
<body><a name=FLIGHT></a>
    <div id="maincontainer">
        <?php $aboutForm = 'GPJQ';  require("top_cnt.php");?>
        <div id="content_area">
                        ...
                        <tr id="content_middle">
                            <td valign="top" colspan="2" >
                                ...
                                <table  cellspacing="0" cellpadding="0" style="width: 100%; height: 300px;">
                                    ...
                                    <iframe src="gpjq_page_cnt.php" id="iframepage_calendar" name="iframepage_calendar" frameBorder="0" scrolling="no" width="959px"  height="4470px"></iframe> 
                                    </td>
