...
<option value="Toronto">Toronto</option>
    ...
    <table width="100%" cellpadding="0" cellspacing="1" class="tableSearchNavHeader" style="display:none;">
        ...
        <span style="font-size:12px; color:red; display:none;"><a href="paytype_cnt.php" target="_parent" style="color:red;display:none;">United, Continental, All Nippon 及 Delta信用卡支付，需另加3%手續費。</a></span>
        </td>
